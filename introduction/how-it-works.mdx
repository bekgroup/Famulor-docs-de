...
- Lernen Sie die [**Wichtigen Begriffe**](/introduction/key-terminology) kennen (wie "KI-Assistent," "Kampagne," etc.).
- Steigen Sie in die [**Ersten Schritte**](/getting-started) ein, um Ihren ersten KI-Assistenten einzurichten. 