...
- Plans vary (e.g., **Starter** at €0.35/min, **Pro** at €0.33/min, **Agency** at €0.11/min).
...
- **AI Rate**: €0.35/min
- **Call Duration**: 30 seconds → 0.5 AI minutes = €0.175 AI cost.
- **Carrier**: €0.01/min, but 30 seconds → 1 minute rounded up → €0.01.
  - €0.01 at your plan's €0.35 rate = 0.03 "plan minutes" used (Or if you do a simpler approach, €0.01 / €0.35 = 0.03 minutes)
- **Total**: 0.5 (AI) + 0.03 (carrier) = 0.53 minutes from your plan. If you had 200 included, you'd have 199.47 left.

### Example B (Inbound Call, Pro Plan)

- **AI Rate**: €0.33/min
- **Call Duration**: 90 seconds → 1.5 AI minutes = €0.495 AI cost.
- **Carrier**: Suppose inbound is €0.015/min, rounding up to 2 minutes if the call was 1.5 min. That's €0.03 total.
  - €0.03 / €0.33 = 0.09 minutes from your plan.
- **Total**: 1.5 (AI) + 0.09 (carrier) = 1.59 minutes deducted.
