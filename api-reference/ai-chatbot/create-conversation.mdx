...
Create a new conversation session with your Famulor AI assistant. Use this endpoint to spin up a widget or test conversation and receive the initial history payload.
