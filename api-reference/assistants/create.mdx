...
<ParamField body="tool_ids" type="integer[]">
  Array von Mid-Call-Tool-IDs, die dem Assistenten zugewiesen werden sollen. Jedes Element muss eine gültige Tool-ID sein, die zu Ihrem Konto gehört.
</ParamField>
