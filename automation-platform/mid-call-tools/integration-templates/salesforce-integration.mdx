...
description: "Enterprise-grade Mid-Call-Tools für Salesforce CRM mit umfangreichen Lead-, Contact- und Opportunity-Management-Funktionen"
icon: "salesforce"
---
...
```mermaid
flowchart TD
    A[Mid-Call-Tool] --> B{Existing Contact?}
...
- [HubSpot Integration](/automation-platform/mid-call-tools/integration-templates/hubspot-kontakt-abruf) für CRM-Vergleiche
- [Webhook-Integration](/automation-platform/mid-call-tools/integration-templates/webhook-automation) für Multi-System-Workflows
- [Slack Integration](/automation-platform/mid-call-tools/integration-templates/slack-integration) für Team-Benachrichtigungen
</Card>
