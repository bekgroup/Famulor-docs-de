...
title: "Famulor Tool"
icon: "phone"
description: "Learn how to use Famulor triggers and actions in your AI calling flows"
---

# Famulor Tool

The Famulor tool is the core component that connects your AI calling system with automation flows. It enables real-time data exchange between your AI assistants and business systems, allowing for personalized conversations and automated follow-ups.

<Note>
  You can find the Famulor tool prominently displayed at the top of the
...
![Famulor Call Ended Trigger](/resources/Famulor-trigger.jpg)
