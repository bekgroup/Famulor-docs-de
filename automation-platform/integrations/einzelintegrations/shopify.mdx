---
title: "Shopify Integration für KI-Telefonassistenten | Famulor Automation"  
  ...
  "webhooks": [
    {
      ...
      "endpoint": "https://api.famulor.de/shopify/order-created"
    },
    {
      "topic": "orders/cancelled", 
      "endpoint": "https://api.famulor.de/shopify/order-cancelled"
    },
    {
      "topic": "products/update",
      "endpoint": "https://api.famulor.de/shopify/inventory-update"  
    }
  ]
}
```
