...
**Beispiel:** `5wed79aeavr.sip.livekit.cloud` (Ihre Adresse steht in Famulor unter „Unsere SIP-Adresse“.)
...
| Problem | Lösung |
|--------|--------|
| FQDN-Feature nicht verfügbar (SIP-Trunk) | E-Mail an support@easybell.de mit Kundennummer; auf Bestätigung warten. |
| Anrufe kommen nicht an | Erlaubte IPs in Famulor prüfen (je nach Weg: SIP-Trunk- oder Cloud-IPs). E.164 mit „+“ prüfen. |
| Falsche Domain | Keine Leerzeichen, ohne `sip:` – nur die Adresse aus Famulor übernehmen. |
