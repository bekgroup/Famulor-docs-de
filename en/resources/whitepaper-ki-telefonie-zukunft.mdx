...
<CardGroup cols={3}>
  <Card title="🚀 Sofort starten" href="/en/getting-started/core-concepts" icon="rocket">
...
Die generative, konversationelle KI von [**Famulor**](/en/introduction/what-is-Famulor) repräsentiert einen fundamentalen Paradigmenwechsel in der Kundeninteraktion. Durch die Kombination modernster **Large Language Models (LLMs)** mit fortschrittlicher **Transformer-basierter Voice-AI** schafft Famulor Interaktionen, die adaptiv, realistisch und bemerkenswert effektiv sind.
...
<Info>
Dieser menschenähnliche Ansatz macht Famulor besonders gut geeignet für [**Verkaufsgespräche**](/en/sales/gespraechsfuehrung-und-einwandbehandlung) und anspruchsvollere [**Support-Anrufe**](/en/ai-assistants/example-prompts/first-level-support).
</Info>

Dieser Wandel stellt einen technologischen Durchbruch dar, der es Famulor ermöglicht, Gespräche zu führen, die natürlich fließen, sich an verschiedene Eingaben anpassen und ein ansprechendes, reibungsloses Kundenerlebnis schaffen. Mit seiner Fähigkeit, komplexe Sprachmuster zu verstehen, kann die [**Conversational AI von Famulor**](/en/conversation-design/prompt-basics) ein weitaus breiteres Spektrum an Anfragen bewältigen als herkömmliche, Intent-basierte Systeme und bietet ein zufriedenstellenderes und intuitiveres Interaktionserlebnis.
    ...
    **Sofort startbereit:**
    ...
    <Steps>
      ...
      <Step title="Ersten AI-Assistenten konfigurieren">
        Verwende unseren [**Custom GPT**](/en/ai-assistants/custom-gpt) für optimierte Prompts
      </Step>
      
      <Step title="Live-Testing">
        Teste deinen Assistenten mit der [**Testing-Funktion**](/en/ai-assistants/testing)
      </Step>
    </Steps>
  </Tab>
    ...
    **Optimierte Implementierung:**
    ...
    <Steps>
      <Step title="Strategische Planung">
        - Use Case definieren mit [**Best Practices**](/en/ai-assistants/assistant-best-practices)
        - [**Assistant Modes**](/en/ai-assistants/assistant-modes) auswählen
        - KPIs und Erfolgsmetriken festlegen
      </Step>
      
      <Step title="Konfiguration & Training">
        - [**System Prompts**](/en/ai-assistants/system-prompt) optimieren
        - [**Knowledge Bases**](/en/conversation-design/knowledge-bases) einrichten
        - [**Voice Selection**](/en/ai-assistants/voice-selection) anpassen
      </Step>
      
      <Step title="Integration & Automation">
        - [**API-Integration**](/en/developers/overview) für bestehende Systeme
        - [**Webhooks**](/en/api-reference/webhooks/post-call) für Datenverarbeitung
        - [**Automation Flows**](/en/automation-platform/introduction) einrichten
      </Step>
    </Steps>
  </Tab>
    ...
    **Vollständige Integration:**
    ...
    <Steps>
      ...
      <Step title="Team-Training">
        - Schulung für [**Prompt Engineering**](/en/ai-assistants/example-prompts/general-prompt-engineering-guide)
      ...
      <Step title="Continuous Optimization">
        ...
        - [**Analytics & Insights**](/en/inbound-calls/insights) Implementation
...
<Steps>
  <Step title="Definiere den Happy Path (Mehrheitsabdeckung, >50%)">
    ...
    **Tipp:** Verwende [**System Prompts**](/en/ai-assistants/system-prompt) um die Grundregeln für häufige Szenarien zu definieren.
  </Step>
  ...
  <Step title="Erweitere auf Sonderfälle (90% Abdeckung)">
    ...
    Stelle eine [**Testleitung**](/en/ai-assistants/testing) für dein Team intern zur Verfügung, um Feedback darüber zu sammeln, wie der Agent in diesen Sonderfällen funktioniert. Diese Feedback-Schleife ist entscheidend für die Identifizierung von Lücken und die Verfeinerung von Antworten.
  </Step>
  ...
  <Step title="Gehe live und überwache Anrufe (30-Tage-Auswertung)">
    ...
    **Tipp:** Nutze [**Eingehende Anrufe - Insights**](/en/inbound-calls/insights) für detaillierte Analyse der Performance.
  </Step>
  ...
  <Step title="Verfeinere und aktualisiere für 99%+ Abdeckung">
    ...
    **Ressourcen:**
    - [**Knowledge Bases**](/en/conversation-design/knowledge-bases) für spezifische Informationen
    - [**Tools und Functions**](/en/ai-assistants/tools-and-functions) für erweiterte Funktionalität
  </Step>
...
<CardGroup cols={2}>
  <Card title="AI-Assistenten erstellen" href="/en/ai-assistants/creating-and-editing" icon="robot">
    **Schritt-für-Schritt Anleitung** zur Erstellung deines ersten Famulor AI-Assistenten
  </Card>
  <Card title="System Prompts optimieren" href="/en/ai-assistants/system-prompt" icon="brain">
    **Prompt Engineering Guide** für optimale Gesprächs-KI-Performance
  </Card>
  <Card title="Best Practices befolgen" href="/en/ai-assistants/assistant-best-practices" icon="star">
    **Bewährte Methoden** und Checkliste für professionelle Implementierung
  </Card>
  <Card title="Custom GPT nutzen" href="/en/ai-assistants/custom-gpt" icon="wand-magic-sparkles">
...
<CardGroup cols={2}>
  ...
  <Card title="Webhook-Setup" href="/en/api-reference/webhooks/post-call" icon="webhook">
  ...
  <Card title="Automation Platform" href="/en/automation-platform/introduction" icon="flow">
...
<CardGroup cols={3}>
  <Card title="Verkauf & Lead-Gen" href="/en/sales/gespraechsfuehrung-und-einwandbehandlung" icon="chart-line">
    Einwandbehandlung und Conversion-Optimierung
  </Card>
  <Card title="Kundensupport" href="/en/ai-assistants/example-prompts/first-level-support" icon="headset">
    First-Level-Support und Problemlösung
  </Card>
  <Card title="Terminbuchung" href="/en/ai-assistants/cal-com-scheduling" icon="calendar">
...
<CardGroup cols={2}>
  <Card title="Testing-Strategien" href="/en/ai-assistants/testing" icon="flask">
    **Systematisches Testen** und Qualitätssicherung
  </Card>
  <Card title="Voice & Modell-Auswahl" href="/en/ai-assistants/voice-selection" icon="microphone">
  ...
  <Card title="Assistant Modes" href="/en/ai-assistants/assistant-modes" icon="settings">
...
<Steps>
  ...
  <Step title="Proof of Concept (Diese Woche)">
    Ersten **[AI-Assistenten erstellen](/en/getting-started/core-concepts)** mit unserem **[Custom GPT](/en/ai-assistants/custom-gpt)**
  </Step>
  
  <Step title="Produktionsreife (Diesen Monat)">
    **[Best Practices befolgen](/en/ai-assistants/assistant-best-practices)** und für den Live-Betrieb optimieren
  </Step>
</Steps>
