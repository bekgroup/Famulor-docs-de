...
<CardGroup cols={3}>
  <Card title="🚀 Get Started Now" href="/getting-started/core-concepts" icon="rocket">
...
<Info>
This human-like approach makes Famulor especially well-suited for [**sales conversations**](/sales/gespraechsfuehrung-und-einwandbehandlung) and more demanding [**support calls**](/ai-assistants/example-prompts/first-level-support).
</Info>

This transformation marks a technological breakthrough, enabling Famulor to create conversations that flow naturally, adapt to different inputs, and deliver an engaging, seamless customer experience. With the ability to understand complex language patterns, the [**Famulor Conversational AI**](/conversation-design/prompt-basics) can handle a much broader range of requests than traditional intent-based systems, providing a more satisfying and intuitive interaction.
    ...
    **Ready to go right away:**
    ...
    <Steps>
      ...
      <Step title="Configure First AI Assistant">
        Use our [**Custom GPT**](/ai-assistants/custom-gpt) for optimized prompts
      </Step>
      
      <Step title="Live Testing">
        Test your assistant using the [**testing function**](/ai-assistants/testing)
      </Step>
    </Steps>
  </Tab>
    ...
    **Optimized implementation:**
    ...
    <Steps>
      <Step title="Strategic Planning">
        - Define use case with [**best practices**](/ai-assistants/assistant-best-practices)
        - Select [**assistant modes**](/ai-assistants/assistant-modes)
        - Set KPIs and success metrics
      </Step>
      
      <Step title="Configuration & Training">
        - Optimize [**system prompts**](/ai-assistants/system-prompt)
        - Set up [**knowledge bases**](/conversation-design/knowledge-bases)
        - Customize [**voice selection**](/ai-assistants/voice-selection)
      </Step>
      
      <Step title="Integration & Automation">
        - [**API integration**](/developers/overview) with existing systems
        - [**Webhooks**](/api-reference/webhooks/post-call) for data processing
        - Set up [**automation flows**](/automation-platform/introduction)
      </Step>
    </Steps>
  </Tab>
    ...
    **Complete integration:**
    ...
    <Steps>
      <Step title="Architecture Design">
        ...
        - [**SIP integration**](/provisioning/sip-ai/overview) for existing telephony
        - Plan scaling architecture
      </Step>
      
      <Step title="Team Training">
        - Training in [**prompt engineering**](/ai-assistants/example-prompts/general-prompt-engineering-guide)
      ...
      <Step title="Continuous Optimization">
        ...
        - Implement [**analytics & insights**](/inbound-calls/insights)
...
<Steps>
  <Step title="Define the Happy Path (Majority Coverage, >50%)">
    ...
    **Tip:** Use [**system prompts**](/ai-assistants/system-prompt) to define basic rules for common scenarios.
  </Step>
  ...
  <Step title="Expand to Edge Cases (90% Coverage)">
    ...
    Provide an internal [**test line**](/ai-assistants/testing) for your team to gather feedback on agent performance in these edge cases. This feedback loop is critical to identifying gaps and refining responses.
  </Step>
  ...
  <Step title="Go Live and Monitor Calls (30-Day Evaluation)">
    ...
    **Tip:** Use [**Inbound Calls - Insights**](/inbound-calls/insights) for detailed performance analysis.
  </Step>
  ...
  <Step title="Refine and Update for 99%+ Coverage">
    ...
    **Resources:**
    - [**Knowledge Bases**](/conversation-design/knowledge-bases) for specific information
    - [**Tools and Functions**](/ai-assistants/tools-and-functions) for advanced functionality
  </Step>
...
<CardGroup cols={2}>
  <Card title="Creating AI Assistants" href="/ai-assistants/creating-and-editing" icon="robot">
    **Step-by-step guide** to building your first Famulor AI assistant
  </Card>
  <Card title="Optimizing System Prompts" href="/ai-assistants/system-prompt" icon="brain">
    **Prompt engineering guide** for optimal conversational AI performance
  </Card>
  <Card title="Follow Best Practices" href="/ai-assistants/assistant-best-practices" icon="star">
    **Best practices** and checklist for professional implementation
  </Card>
  <Card title="Use Custom GPT" href="/ai-assistants/custom-gpt" icon="wand-magic-sparkles">
...
<CardGroup cols={2}>
  ...
  <Card title="Webhook Setup" href="/api-reference/webhooks/post-call" icon="link">
  ...
  <Card title="Automation Platform" href="/automation-platform/introduction" icon="diagram-project">
...
<CardGroup cols={3}>
  <Card title="Sales & Lead Gen" href="/sales/gespraechsfuehrung-und-einwandbehandlung" icon="chart-line">
    Objection handling and conversion optimization
  </Card>
  <Card title="Customer Support" href="/ai-assistants/example-prompts/first-level-support" icon="headset">
    First-level support and problem solving
  </Card>
  <Card title="Appointment Booking" href="/ai-assistants/cal-com-scheduling" icon="calendar">
...
<CardGroup cols={2}>
  <Card title="Testing Strategies" href="/ai-assistants/testing" icon="flask">
    **Systematic testing** and quality assurance
  </Card>
  <Card title="Voice & Model Selection" href="/ai-assistants/voice-selection" icon="microphone">
  ...
  <Card title="Assistant Modes" href="/ai-assistants/assistant-modes" icon="gear">
...
<Steps>
  ...
  <Step title="Proof of Concept (This Week)">
    Create your first **[AI assistant](/getting-started/core-concepts)** with our **[Custom GPT](/ai-assistants/custom-gpt)**
  </Step>
  
  <Step title="Production Ready (This Month)">
    Follow **[best practices](/ai-assistants/assistant-best-practices)** and optimize for live operation
  </Step>
</Steps>
