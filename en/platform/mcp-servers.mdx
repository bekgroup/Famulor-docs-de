...
<Frame>
<img src="/images/mcp-server-form.png" alt="MCP server configuration form — display name, identifier, server URL, transport, and authentication headers" />
</Frame>
...
<Frame>
<img src="/images/mcp-servers-list.png" alt="MCP servers list with connection status and discovered tools" />
</Frame>
