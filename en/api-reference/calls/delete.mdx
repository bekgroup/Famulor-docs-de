...
description: "Delete a specific call record from the Famulor system via API. Permanently removes transcripts, recordings and metadata for that voice agent call."
---
