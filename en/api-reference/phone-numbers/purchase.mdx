...
description: "Purchase a dedicated phone number in Famulor via API. Acquire local, mobile or toll-free numbers for inbound or outbound AI voice agent calls."
---

This endpoint allows you to purchase a phone number that was found via the [Search endpoint](/en/api-reference/phone-numbers/search). The platform automatically handles pricing, billing, and provisioning.
...
1. **Search** - First use the [Search endpoint](/en/api-reference/phone-numbers/search) to find available numbers
...
<Warning>
Phone number purchases are non-refundable. The subscription will continue until you [release](/en/api-reference/phone-numbers/release) the number.
</Warning>
