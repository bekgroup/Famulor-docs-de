...
<Note>
  See [Release phone number](/en/api-reference/phone-numbers/release) for the full endpoint documentation. SIP trunks are immediately deleted and return `"Phone number deleted successfully."`.
</Note>
