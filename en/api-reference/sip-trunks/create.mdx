...
<ResponseField name="data" type="object">
  The created SIP trunk object (same fields as [Get SIP trunk](/en/api-reference/sip-trunks/get))
</ResponseField>
...
* **[Create Assistant](/en/api-reference/assistants/create)** - Use the `phone_number_id` parameter
* **[Update Assistant](/en/api-reference/assistants/update)** - Change the phone number on an existing assistant
