...
description: "Modify an existing mid-call tool in Famulor via API. Update name, endpoint, parameters or description so AI voice agents call the right action."
---
...
<ParamField body="schema" type="array" optional>
  ...
  <Expandable title="schema properties">
    ...
    <ParamField body="description" type="string" required>
      Parameter description (3-255 characters)
    </ParamField>
  </Expandable>
</ParamField>
...
- **[Update Assistant](/en/api-reference/assistants/update)** - Use the `tool_ids` parameter to manage which tools are assigned to an assistant
