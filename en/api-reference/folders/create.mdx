...
Create a folder to group your assistants. Assign assistants to a folder with the `folder_id` field on the [Create Assistant](/en/api-reference/assistants/create) and [Update Assistant](/en/api-reference/assistants/update) endpoints.
