...
title: "Create lead"
api: "POST /user/lead"
description: "Add a new lead to your Famulor outbound calling campaign via API. Submit contact information, custom variables and trigger AI voice agent calls."
---
