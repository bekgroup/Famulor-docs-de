...
description: "Permanently remove a lead from your Famulor account via API. Deletes all associated call data, transcripts and notes for that contact record."
---
