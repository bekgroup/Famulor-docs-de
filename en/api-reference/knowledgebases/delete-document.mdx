...
description: "Delete a specific document from a Famulor knowledge base via API. Permanently removes its content from the RAG index used by your AI voice assistant."
---
