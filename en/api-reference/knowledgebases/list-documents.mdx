...
description: "List all documents stored in a specific Famulor knowledge base via API. Inspect filenames, sizes and indexing status used by AI voice assistants."
---
