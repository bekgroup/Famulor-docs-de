...
description: "Upload a new document to a Famulor knowledge base via API. Add PDFs, text, FAQs or product data that AI voice assistants can reference during calls."
---
...
<Note>
  Document processing is asynchronous. Call the [Get Document](/en/api-reference/knowledgebases/get-document) endpoint to check when processing is complete.
</Note>
