...
description: "Permanently delete a Famulor knowledge base and all its documents via API. AI voice assistants will lose access to the indexed content immediately."
---
