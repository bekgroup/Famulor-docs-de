...
description: "Update an existing Famulor knowledge base via API. Rename, change settings or modify metadata for the source data feeding your AI voice assistants."
---
