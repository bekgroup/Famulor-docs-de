...
description: "Create a new outbound calling campaign in Famulor via API. Assign a voice agent, upload leads and launch automated AI phone outreach at scale."
---
