...
description: "Delete an outbound calling campaign via API. Running campaigns are stopped automatically before removal; leads and phone number assignments are released."
---
