...
description: "Start, pause or stop a Famulor outbound calling campaign via API. Programmatically control AI voice agent dialling schedules and lead processing."
---
