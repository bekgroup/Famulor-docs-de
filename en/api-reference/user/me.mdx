...
description: "Retrieve the profile, settings and account details of the currently authenticated Famulor user via API. Useful for verifying tokens and account state."
---
