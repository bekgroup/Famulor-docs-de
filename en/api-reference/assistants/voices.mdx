...
<ParamField query="language_id" type="integer">
  Filter voices by language ID. Use the [Retrieve Languages](/en/api-reference/assistants/languages) endpoint to get available language IDs.
</ParamField>
...
<ResponseField name="data" type="array">
  <Expandable title="Properties">
    ...
    <ResponseField name="synthesizer_provider_id" type="integer">
      The TTS provider ID to which this voice belongs. Use the [Retrieve Synthesizer Providers](/en/api-reference/assistants/synthesizer-providers) endpoint to resolve provider names. Can be `null`.
    </ResponseField>
  </Expandable>
</ResponseField>
