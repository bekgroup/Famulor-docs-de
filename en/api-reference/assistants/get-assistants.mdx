...
description: "Retrieve all assistants in your account with pagination"
---

Get a paginated list of all AI assistants you've created. Results include full configuration details for each assistant.
...
<ResponseField name="data" type="array">
  <Expandable title="properties">
    ...
    <ResponseField name="phone_number_id" type="integer">
      Phone number identifier assigned to this assistant
    </ResponseField>
    ...
    <ResponseField name="voice_id" type="integer">
      Voice identifier used by the assistant
    </ResponseField>

    <ResponseField name="instance_id" type="integer">
      Instance identifier for the assistant
    </ResponseField>
    ...
    <ResponseField name="variables" type="object">
      Custom variables configured for the assistant
    </ResponseField>

    <ResponseField name="post_call_evaluation" type="boolean">
      Whether AI-powered post-call evaluation is enabled
    </ResponseField>

    <ResponseField name="fillers" type="integer">
      Filler audio setting (1 = enabled, 0 = disabled)
    </ResponseField>
    ...
    <ResponseField name="status" type="string">
      Current assistant status (active or inactive)
    </ResponseField>
...
```json 200 Response
{
  ...
  "first_page_url": "https://app.famulor.de/api/user/assistants/get?page=1",
  "from": 1,
  "last_page": 5,
  "last_page_url": "https://app.famulor.de/api/user/assistants/get?page=5",
  "links": [
    {
      "url": null,
    ...
    {
      "url": "https://app.famulor.de/api/user/assistants/get?page=1",
      "label": "1",
      "active": true
    },
    {
      "url": "https://app.famulor.de/api/user/assistants/get?page=2",
      "label": "2",
      "active": false
    }
  ],
  "next_page_url": "https://app.famulor.de/api/user/assistants/get?page=2",
  "path": "https://app.famulor.de/api/user/assistants/get",
  "per_page": 10,
  "prev_page_url": null,
  "to": 10,
  "total": 47
