...
description: "Turn off webhook notifications for a specific Famulor AI assistant via API. Stops automated event delivery for call ended, lead created, and other triggers."
---
