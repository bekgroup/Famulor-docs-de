...
Check whether an active 24-hour WhatsApp messaging window exists between your Famulor WhatsApp sender and a specific recipient. Use this endpoint to determine whether you can send [freeform messages](/api-reference/whatsapp/send-freeform) or need to use a [template message](/api-reference/whatsapp/send-template).
