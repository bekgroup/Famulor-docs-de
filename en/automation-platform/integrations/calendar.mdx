...
<CardGroup cols={2}>
  ...
  <Card title="Productivity" icon="tasks" href="/automation-platform/integrations/productivity">
...
**Support**: For assistance with calendar integrations, contact us at [support@famulor.de](mailto:support@famulor.de).