...
description: "Documentation for ROI Calculator in the Famulor platform"
---

This page documents **ROI Calculator** for the Famulor documentation set.

## Overview

Use this page as the canonical reference for ROI Calculator in automation and assistant workflows.
