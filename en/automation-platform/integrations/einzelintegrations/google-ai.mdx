---
title: "Google AI"
description: "Documentation for Google AI in the Famulor platform"
---

This page documents **Google AI** for the Famulor documentation set.

## Overview

Use this page as the canonical reference for Google AI in automation and assistant workflows.
