---
title: "Excel"
description: "Integrate Microsoft Excel with Famulor AI voice agents. Read leads, write call outcomes and automate reporting workflows between phone calls and spreadsheets."
---

This page documents **Excel** for the Famulor documentation set.

## Overview

Use this page as the canonical reference for Excel in automation and assistant workflows.
