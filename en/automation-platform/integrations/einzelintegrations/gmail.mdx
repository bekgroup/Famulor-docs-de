...
<CardGroup cols={2}>
  ...
  <Card title="Email Templates" icon="file-text" href="/en/automation-platform/integrations/email-marketing#gmail-templates">
...
<CardGroup cols={3}>
  <Card title="Outlook" icon="microsoft" href="/en/automation-platform/integrations/einzelintegrations/outlook">
    Microsoft Email Alternative
  </Card>
  <Card title="Mailchimp" icon="envelope-open" href="/en/automation-platform/integrations/einzelintegrations/mailchimp">
    Advanced Email Marketing Automation
  </Card>
  <Card title="HubSpot Marketing" icon="users" href="/en/automation-platform/integrations/einzelintegrations/hubspot">
