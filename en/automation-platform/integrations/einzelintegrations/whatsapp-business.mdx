...
description: "Documentation for Whatsapp Business in the Famulor platform"
---

This page documents **Whatsapp Business** for the Famulor documentation set.

## Overview

Use this page as the canonical reference for Whatsapp Business in automation and assistant workflows.
