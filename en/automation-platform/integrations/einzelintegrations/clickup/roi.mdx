---
title: "ROI"
description: "Measure the ROI of your ClickUp + Famulor integration. Calculate time saved, deals closed and productivity gains from AI voice agent automation in ClickUp."
---

This page documents **ROI** for the Famulor documentation set.

## Overview

Use this page as the canonical reference for ROI in automation and assistant workflows.
