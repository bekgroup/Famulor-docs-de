...
<CardGroup cols={2}>
  ...
  <Card title="Meeting Templates" icon="clone" href="/en/automation-platform/integrations/einzelintegrations/google-calendar/templates">
    Pre-made meeting templates
  </Card>
  <Card title="Advanced Setup Guide" icon="gear" href="/en/automation-platform/integrations/einzelintegrations/google-calendar/advanced-setup">
