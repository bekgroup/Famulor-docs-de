---
title: "Signal"
description: "Integrate Signal with Famulor AI voice agents for secure encrypted messaging. Trigger notifications and follow-ups from calls, leads or automation flows."
---

This page documents **Signal** for the Famulor documentation set.

## Overview

Use this page as the canonical reference for Signal in automation and assistant workflows.
