...
<CardGroup cols={2}>
  ...
  <Card title="Workflow Templates" icon="diagram-project" href="/en/automation-platform/integrations/einzelintegrations/slack/workflows">
    Pre-built Slack automation workflows
  </Card>
  <Card title="Best Practices Guide" icon="lightbulb" href="/en/automation-platform/integrations/einzelintegrations/slack/best-practices">
