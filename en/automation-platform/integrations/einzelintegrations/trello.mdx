...
<CardGroup cols={2}>
  ...
  <Card title="Board Templates" icon="clone" href="/en/automation-platform/integrations/einzelintegrations/trello/templates">
    Preconfigured Kanban board setups
  </Card>
  <Card title="Workflow Guide" icon="diagram-project" href="/en/automation-platform/integrations/einzelintegrations/trello/workflows">
