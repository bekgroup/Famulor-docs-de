...
<CardGroup cols={2}>
  ...
  <Card title="Prompt Templates" icon="code" href="/en/automation-platform/integrations/ai-machine-learning#openai-prompts">
    Proven prompts for your industry
  </Card>
  <Card title="API Documentation" icon="book" href="/en/automation-platform/integrations/einzelintegrations/openai">
...
<CardGroup cols={3}>
  <Card title="Anthropic Claude" icon="brain" href="/en/automation-platform/integrations/einzelintegrations/anthropic-claude">
    Alternative to OpenAI with focus on security
  </Card>
  <Card title="Google AI" icon="search" href="/en/automation-platform/integrations/einzelintegrations/google-ai">
    Multimodal AI for complex applications  
  </Card>
  <Card title="HubSpot AI" icon="users" href="/en/automation-platform/integrations/einzelintegrations/hubspot">
