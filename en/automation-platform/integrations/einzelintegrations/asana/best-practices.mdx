...
description: "Documentation for Best Practices in the Famulor platform"
---

This page documents **Best Practices** for the Famulor documentation set.

## Overview

Use this page as the canonical reference for Best Practices in automation and assistant workflows.
