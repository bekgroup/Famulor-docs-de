...
description: "Documentation for Outlook Calendar in the Famulor platform"
---

This page documents **Outlook Calendar** for the Famulor documentation set.

## Overview

Use this page as the canonical reference for Outlook Calendar in automation and assistant workflows.
