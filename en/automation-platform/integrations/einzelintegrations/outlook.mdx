---
title: "Outlook"
description: "Integrate Microsoft Outlook with Famulor AI voice agents. Send emails, sync contacts and automate follow-ups triggered by inbound or outbound phone calls."
---

This page documents **Outlook** for the Famulor documentation set.

## Overview

Use this page as the canonical reference for Outlook in automation and assistant workflows.
