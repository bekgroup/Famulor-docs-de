...
<CardGroup cols={3}>
  ...
  <Card title="Notion" icon="note-sticky" href="/automation-platform/integrations/einzelintegrations/notion">
    **All-in-One Workspace**
    
    CRM capabilities combined with documentation, project management, and team collaboration.
  </Card>
  
  <Card title="Monday.com" icon="table-columns" href="/automation-platform/integrations/einzelintegrations/monday">
    **Visual Project CRM**
