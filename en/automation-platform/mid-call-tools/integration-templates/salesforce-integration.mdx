...
- [HubSpot Integration](/automation-platform/mid-call-actions/integration-templates/hubspot-kontakt-abruf) for CRM comparisons  
- [Webhook Integration](/automation-platform/mid-call-actions/integration-templates/webhook-automation) for multi-system workflows  
