...
Integrieren Sie Mailchimp-Subscriber-Management in Ihre Mid-call Actions und ermöglichen Sie es Ihrem KI-Assistenten, während Kundengesprächem automatisch interessierte Leads zu Marketing-Listen hinzuzufügen und Marketing-Automation-Workflows auszulösen.
