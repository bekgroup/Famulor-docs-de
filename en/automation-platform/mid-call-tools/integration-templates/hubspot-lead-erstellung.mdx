...
- [HubSpot Deal Management](/en/automation-platform/mid-call-tools/integration-templates/hubspot-deal-management) for sales pipeline management  
- [Webhook Integration](/en/automation-platform/mid-call-tools/integration-templates/webhook-automation) for complex multi-system workflows  
- [SendGrid Integration](/en/automation-platform/mid-call-tools/integration-templates/sendgrid-integration) for automated follow-up emails  
</Card>
