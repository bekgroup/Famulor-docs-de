...
- [Webhook Automation](/automation-platform/mid-call-actions/integration-templates/webhook-automation) for more complex workflows
- [Zapier Integration](/automation-platform/integrations/zapier) for no-code automation
- [HubSpot Integration](/automation-platform/mid-call-actions/integration-templates/hubspot-kontakt-abruf) for CRM upgrade
</Card>
