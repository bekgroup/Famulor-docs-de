...
description: "Mid-call Action für Echtzeit-Zugriff und -Updates von Google Sheets-Daten während Kundengesprächem"
icon: "table"
---
...
- [Webhook-Automation](/automation-platform/mid-call-actions/integration-templates/webhook-automation) für komplexere Workflows
- [Zapier-Integration](/en/automation-platform/integrations/zapier) für No-Code-Automatisierung
- [HubSpot Integration](/automation-platform/mid-call-actions/integration-templates/hubspot-kontakt-abruf) für CRM-Upgrade
</Card>
