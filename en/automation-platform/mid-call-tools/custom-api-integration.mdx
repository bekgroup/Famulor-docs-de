...
description: "Documentation for Custom API Integration in the Famulor platform"
---

This page documents **Custom API Integration** for the Famulor documentation set.

## Overview

Use this page as the canonical reference for Custom API Integration in automation and assistant workflows.
