...
title: "Passing Data"
icon: "wand-sparkles"
description: "Pass data between automation steps in Famulor flows. Reference outputs from previous nodes to enrich AI voice agent context and chain integrations seamlessly."
---
