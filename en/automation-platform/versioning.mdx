...
icon: "clock"
description: "Learn how flow versioning works in famulor.de"
---
...
4. If you try to edit a published flow, famulor.de will create a new **draft** if there is none and copy the **published** version to the new version.
...
![Flow version history interface showing draft (yellow dot) and published (green dot) versions](/resources/flow-history.png)
