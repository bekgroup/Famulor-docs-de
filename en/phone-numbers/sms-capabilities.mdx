...
<Card
  ...
  icon="book-open"
  href="/en/automation-platform/calls-related/sms-capabilities">
  ...
  Documentation](/en/automation-platform/calls-related/sms-capabilities).
</Card>
...
**Want to start sending SMS?** Check out our [automation platform documentation](/en/automation-platform/calls-related/sms-capabilities) to learn how to set up SMS workflows.
