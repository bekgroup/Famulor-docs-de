...
6. Click **Create** - this opens the setup wizard
   ...
   <Frame>
     <img src="/images/telnyx/telnyx-create-connection.png" alt="Create SIP connection in Telnyx" width="1949" height="747" />
   </Frame>
...
2. Click **Save**
   ...
   <Frame>
     <img src="/images/telnyx/telnyx-add-fqdn.png" alt="Add FQDN to Telnyx connection" width="1597" height="775" />
   </Frame>
...
3. **Primary FQDN**: Select `{famulorsipadress}.sip.livekit.cloud` from the dropdown
   ...
   <Frame>
     <img src="/images/telnyx/telnyx-inbound-routing.png" alt="Configure inbound calls routing" width="1564" height="803" />
   </Frame>
...
2. Set a **username** and **password** - save these, you need them when importing the number into Famulor
   ...
   <Frame>
     <img src="/images/telnyx/telnyx-outbound-credentials.png" alt="Set outbound credentials" width="638" height="318" />
   </Frame>
...
<Frame>
  <img src="/images/telnyx/telnyx-configuration.png" alt="Configuration page" width="1308" height="809" />
</Frame>
...
3. **Channel limit**: Set to `10` or higher
   ...
   <Frame>
     <img src="/images/telnyx/telnyx-outbound-settings.png" alt="Configure outbound settings" width="1590" height="537" />
   </Frame>
...
2. Click **Edit**
   ...
   <Frame>
     <img src="/images/telnyx/telnyx-outbound-voice-profiles.png" alt="Open outbound voice profiles" width="1911" height="722" />
   </Frame>
...
4. Enable the countries/regions you need to call
   ...
   <Frame>
     <img src="/images/telnyx/telnyx-geographic-permissions.png" alt="Enable geographic permissions" width="1462" height="777" />
   </Frame>
...
1. Open the Phone Numbers page directly:
...
2. Click **"Integrate SIP trunk"** (top-right corner of the page)
   ...
   <Frame>
     <img src="/images/telnyx/telnyx-famulor-sip-button.png" alt="Import number via SIP trunk in Famulor" width="1013" height="481" />
   </Frame>
...
4. Enter outbound settings:
   ...
   <Frame>
     <img src="/images/telnyx/telnyx-famulor-outbound.png" alt="Configure outbound settings in Famulor" width="979" height="758" />
   </Frame>
...
5. Select **Authorization type**: **IP Address** and add the Telnyx IP addresses for your region:
   ...
   * **Australia**: `103.115.244.145` and `103.115.244.146`
   ...
   <Frame>
     <img src="/images/telnyx/telnyx-famulor-inbound.png" alt="Configure inbound IP addresses in Famulor" width="972" height="588" />
   </Frame>
