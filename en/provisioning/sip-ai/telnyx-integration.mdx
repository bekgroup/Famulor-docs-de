...
<Note>
**Phone number import (BYOC):** In the Famulor dashboard, open **Your Phone Numbers → Integrate SIP trunk**, pick **Telnyx** in the carrier list, and use the guided flow to connect your account and import numbers automatically. The steps below are the **manual** SIP trunking setup. Overview: [SIP Integration](/en/provisioning/sip-ai/sip-integration).
</Note>
