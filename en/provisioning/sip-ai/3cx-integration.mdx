...
4. Enter your details according to your 3CX configuration:
   ...
   <Frame>
     <img src="/resources/twillio-credential-settings.png" alt="Import numbers into Famulor" />
   </Frame>

   <Frame>
     <img src="/resources/twillio-outbound-settings.png" alt="Configure outbound settings" />
   </Frame>
