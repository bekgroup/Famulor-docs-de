...
<Warning>
  ...
  **Recommendation for Vonage:** use the **warm transfer**. Famulor places a **separate outbound call** to the contact through the Vonage trunk and bridges both parties – this needs **no** REFER and works with Vonage.
</Warning>
...
<AccordionGroup>
  ...
  <Accordion title="Cold transfer does not work" icon="phone-arrow-up-right">
    **Vonage does not support SIP REFER**, which Famulor uses for cold transfer. Use the **warm transfer** instead – it places a separate outbound call and works with Vonage. Details: [Assistant call forwarding](/en/platform/assistant-call-forwarding).
  </Accordion>
</AccordionGroup>
