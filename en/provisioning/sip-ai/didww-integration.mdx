...
<img
  ...
  alt="DIDWW: inbound SIP trunk – Friendly Name, SIP Endpoint Hostname (your „Our SIP address“) and Transport"
/>
...
<img
  ...
  alt="DIDWW: Phone Numbers → My Numbers, number selected, Batch Actions → Update Trunks"
/>

<img
  src="/images/didww/didww-assign-trunk.png"
  alt="DIDWW: „Update Voice IN Trunk“ dialog – select the inbound trunk for the number"
/>
...
<img
  ...
  alt="DIDWW: outbound trunk – „Credentials & IP-Based“ authentication and Allowed SIP IP addresses"
/>

<img
  src="/images/didww/didww-outbound-credentials.png"
  alt="DIDWW: outbound trunk list – open credentials via the key icon"
/>
