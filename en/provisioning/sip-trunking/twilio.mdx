...
<Note>
**Phone number import (BYOC):** In the Famulor dashboard, open **Your Phone Numbers → Integrate SIP trunk**, pick **Twilio** in the carrier list, and use the guided flow to connect your account and import numbers automatically. The steps below are the **manual** Elastic SIP Trunking setup. Overview: [SIP Integration](/en/provisioning/sip-ai/sip-integration).
</Note>

<Info>
  **Pricing snapshot:** Public Elastic SIP Trunking pricing checked against Twilio's official country pages.

  * **Germany:** local number `from $1.35/month`, inbound origination `from $0.0060/min`, outbound termination `from $0.0170/min`
  * **Switzerland:** local number `from $1.15/month`, inbound origination `from $0.0060/min`, outbound termination `from $0.0334/min`
  * **United Kingdom:** local number `from $1.15/month`, inbound origination `from $0.0060/min`, outbound termination `from $0.0118/min`
  * **United States:** local number `from $1.15/month`, inbound origination `from $0.0034/min`, outbound termination `from $0.0011/min`
  * **Official pricing:** [Germany](https://www.twilio.com/en-us/sip-trunking/pricing/de), [Switzerland](https://twilio.com/en-us/sip-trunking/pricing/ch), [United Kingdom](https://twilio.com/en-us/sip-trunking/pricing/gb), [United States](https://www.twilio.com/sip-trunking/pricing/us)
</Info>
