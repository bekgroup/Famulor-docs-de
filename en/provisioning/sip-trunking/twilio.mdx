...
<Tip>
**Prefer automatic import?** In the Famulor dashboard, use **Your Phone Numbers → Integrate SIP trunk**, choose **Twilio** in the BYOC carrier picker, and follow the guided wizard to connect credentials and import numbers. This page documents the **manual** Elastic SIP Trunking setup if you need full control or are following a legacy workflow.
</Tip>
