...
description: "Learn about Famulor.io's built-in automation engine for creating workflows without coding"
---
...
- **Triggers**: Events inside Famulor.io (e.g., "call ended," "inbound call context injection").
