...
description: "Learn about famulor.de's built-in automation engine for creating workflows without coding"
---
...
<Card
  ...
  [Automation Platform Documentation](/en/automation-platform/introduction).
</Card>

famulor.de includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside famulor.de (e.g., "call ended," "inbound call context injection").
...
**Want to learn more?** Check out our [detailed automation documentation](/en/automation-platform/introduction) for advanced features, tutorials, and best practices.
