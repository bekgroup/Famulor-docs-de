...
* Learn more about [message templates](/en/whatsapp/templates) and how to create them  
* Set up [WhatsApp senders](/en/whatsapp/senders) for your phone numbers  
* Explore the [automation platform](/en/automation-platform/introduction) for more workflow options
