...
<CardGroup cols={2}>
  <Card title="WhatsApp-Absender" icon="phone" href="/en/whatsapp/senders">
    Telefonnummern, die für WhatsApp Business Messaging registriert sind
  </Card>

  <Card title="Nachrichten-Templates" icon="file-lines" href="/en/whatsapp/templates">
    Vorab genehmigte Nachrichtenformate für geschäftlich initiierte Gespräche
  </Card>

  <Card title="KI-Konversationen" icon="robot" href="/en/whatsapp/conversations">
    KI-gestützte automatisierte Antworten auf Kunden-Nachrichten
  </Card>

  <Card title="Automatisierung" icon="bolt" href="/en/whatsapp/automation">
...
* Erfahren Sie, wie Sie [WhatsApp-Absender erstellen](/en/whatsapp/senders)
* [Nachrichten-Templates](/en/whatsapp/templates) und den Genehmigungsprozess verstehen
* [Automatisierungs-Trigger](/en/whatsapp/automation) für WhatsApp einrichten
