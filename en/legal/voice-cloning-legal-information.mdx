...
<CardGroup cols={2}>
  <Card title="Nächste Schritte" icon="arrow-right" href="/en/legal/voice-cloning-compliance">
    Compliance-Leitfaden und praktische Umsetzung
  </Card>
  <Card title="Vertragsvorlagen" icon="file-contract" href="/en/legal/voice-cloning-contracts">
