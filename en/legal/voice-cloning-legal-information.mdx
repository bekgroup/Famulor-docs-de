...
<CardGroup cols={2}>
  <Card title="Next Steps" icon="arrow-right" href="/legal/voice-cloning-compliance">
    Compliance guide and practical implementation
  </Card>
  <Card title="Contract Templates" icon="file-contract" href="/legal/voice-cloning-contracts">
