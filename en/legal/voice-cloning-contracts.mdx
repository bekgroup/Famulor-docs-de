...
<CardGroup cols={2}>
  <Card title="Zurück zur Übersicht" icon="arrow-left" href="/en/legal/voice-cloning-legal-information">
    Hauptdokument: Rechtliche Informationen
  </Card>
  <Card title="Compliance-Leitfaden" icon="clipboard-check" href="/en/legal/voice-cloning-compliance">
