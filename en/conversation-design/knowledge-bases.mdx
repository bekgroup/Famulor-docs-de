...
- Famulor.io plans to introduce a dedicated "Knowledge Base" or doc upload feature.
...
<Tip>
Related pages: [Prompt Basics](/en/conversation-design/prompt-basics), and [Interruptions](/en/conversation-design/interruptions).
</Tip>
