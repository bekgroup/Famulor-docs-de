...
Phone conversations can be messy—callers may interrupt the AI or have background noise. Famulor.io provides **voice activity detection** and **speech settings** to handle these situations.
...
<Tip>
Related pages: [Prompt Basics](/en/conversation-design/prompt-basics), and [Knowledge Bases](/en/conversation-design/knowledge-bases).
</Tip>
