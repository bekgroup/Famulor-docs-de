...
famulor.de offers multiple languages and accents for your AI assistant. Choose from built-in sets or request new ones if needed.
...
- **Others**: +40 languages supported, [play samples here](https://app.famulor.de/#languages-available)
...
<Tip>
Related pages: [Prompt Basics](/en/conversation-design/prompt-basics) and [Knowledge Bases](/en/conversation-design/knowledge-bases), and [Interruptions](/en/conversation-design/interruptions).
</Tip>
