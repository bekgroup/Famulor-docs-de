...
| Endpoint | URL |
| --- | --- |
| **MCP (canonical)** | `https://app.famulor.de/mcp` |
| **Base URL** | `https://app.famulor.de/` (also accepted) |
| **Health** | [https://app.famulor.de/health](https://app.famulor.de/health) |
| **OAuth metadata** | `https://app.famulor.de/.well-known/oauth-authorization-server` |

Both `https://app.famulor.de/` and `https://app.famulor.de/mcp` work as MCP URLs in connector dialogs.
