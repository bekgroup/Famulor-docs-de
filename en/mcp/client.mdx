...
Both `https://app.famulor.de/` and `https://app.famulor.de/mcp` work — paste either into your client's connector dialog.
...
| **MCP server URL** | `https://mcp.famulor.io` or `https://app.famulor.de/mcp` |
...
- Use `https://app.famulor.de/mcp` (or `https://app.famulor.de/`).
