...
<Card title="Position and Color" icon="book-user" color="orange">
...
<CardGroup cols={2}>
  ...
  <Card title="CMS Systems" icon="cms" color="purple">
...
<Card title="Testing the Widget" icon="test-tube" color="purple">
