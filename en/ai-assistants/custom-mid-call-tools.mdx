...
<CardGroup cols={3}>
  <Card title="Understanding Mid-call Actions" icon="lightbulb" href="/automation-platform/mid-call-tools/was-sind-mid-call-tools">
    Learn more about the technical basics and how they work
  </Card>
  <Card title="Use Cases" icon="map" href="/automation-platform/mid-call-tools/wann-verwenden">
...
<AccordionGroup>
  <Accordion title="CRM Integrations">
    - [HubSpot Contact Retrieval](/automation-platform/mid-call-tools/integration-templates/hubspot-kontakt-abruf)
  ...
  <Accordion title="Communication & Marketing">
    - [Slack Notifications](/automation-platform/mid-call-tools/integration-templates/slack-integration)
    - [SendGrid Email Sending](/automation-platform/mid-call-tools/integration-templates/sendgrid-integration)
  ...
  <Accordion title="Project Management">
    - [Asana Task Creation](/automation-platform/mid-call-tools/integration-templates/asana-integration)
    - [Jira Issue Management](/automation-platform/mid-call-tools/integration-templates/jira-integration)
    - [Notion Documentation](/automation-platform/mid-call-tools/integration-templates/notion-integration)
  </Accordion>
  
  <Accordion title="Advanced Automation">
    - [Webhook Integration with Famulor Automation](/automation-platform/mid-call-tools/integration-templates/webhook-automation)
    - [API Base Templates](/automation-platform/mid-call-tools/integration-templates/api-vorlagen)
  </Accordion>
</AccordionGroup>
