...
icon: "calendar-days"
description: "Learn how to enable your AI assistant to schedule appointments using Calendly integration"
---
...
<Note>
  For troubleshooting, see [Calendly Issues](/en/troubleshooting/calendly-issues).
</Note>
