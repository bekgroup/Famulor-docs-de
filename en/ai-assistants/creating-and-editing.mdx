...
keywords: ["create AI assistant", "edit voice agent", "AI assistant setup", "voice agent configuration", "inbound calls", "outbound calls", "Famulor assistant"]
---
...
In your Famulor.io dashboard, find the **Assistants** page (sometimes labeled "AI Assistants" or similar).
...
- Add or remove items like **transfer call**, **end call**, or **appointment scheduling** (more in [Tools & Functions](/en/ai-assistants/tools-and-functions)).
