...
<AccordionGroup>
  ...
  <Accordion title="Example: Handle scenario" icon="shield-check">
...
* [System Prompt Guide](/ai-assistants/system-prompt) – Deep dive into writing prompts
* [Flow Builder](/ai-assistants/flow-builder) – Visual alternative for conversation design
* [Testing Assistants](/ai-assistants/testing) – How to test your changes