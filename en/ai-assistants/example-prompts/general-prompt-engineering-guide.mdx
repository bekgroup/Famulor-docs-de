...
<Card title="Why Structured Prompts?" icon="layers" color="blue">
...
<CardGroup cols={2}>
  ...
  <Card title="Technical Integration" icon="function" color="green">
...
<Card title="What to Avoid" icon="ball-pile" color="red">
