...
<Card title="Technical Setup" icon="settings" color="red">
...
<CardGroup cols={2}>
  ...
  <Card title="Extend FAQs" icon="help-circle" color="green">
...
<Card title="Steps for setup" icon="settings" color="orange">
