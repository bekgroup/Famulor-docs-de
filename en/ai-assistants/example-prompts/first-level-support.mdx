...
<CardGroup cols={2}>
  ...
  <Card title="Functions" icon="help-circle" color="green">
...
<Card title="Forwarding Rules" icon="phone-forward" color="orange">
...
<Card title="Technical Setup" icon="phone-intercom" color="red">
...
<CardGroup cols={2}>
  <Card title="Expand FAQ" icon="flask-gear" color="blue">
  ...
  <Card title="Adjust Data" icon="circle-dashed" color="green">
...
<Card title="Setup Steps" icon="arrow-progress" color="orange">
