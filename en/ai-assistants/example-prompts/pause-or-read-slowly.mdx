...
<Card title="Why use pauses?" icon="volume-2" color="blue">
...
<Card title="Adding simple pauses" icon="gauge-circle-minus" color="green">
...
<Card title="What to avoid" icon="user-helmet-safety" color="red">
