---
title: 'Development'
description: "Preview your Famulor documentation changes locally before deploying. Set up the Mintlify CLI and run a live development server for instant feedback."
keywords: ["Famulor docs development", "Mintlify CLI", "local preview", "docs setup", "dev server", "documentation workflow"]
---
