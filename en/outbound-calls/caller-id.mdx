...
- **No OTP verification needed** for numbers rented through Famulor.io.
...
<Tip>
Related pages: [Overview](/en/outbound-calls/overview) and [Campaigns](/en/outbound-calls/campaigns), and [Scripts And Prompts](/en/outbound-calls/scripts-and-prompts).
</Tip>
