...
- **CRM**: Some CRMs (HubSpot, GHL, etc.) can send leads directly to Famulor.io via API or automation.
...
<Tip>
Related pages: [Overview](/en/outbound-calls/overview), and [Scripts And Prompts](/en/outbound-calls/scripts-and-prompts).
</Tip>
