...
Famulor supports outbound call campaigns where the AI calls leads or customers automatically. Ideal for:
...
<Tip>
Related pages: [Campaigns](/en/outbound-calls/campaigns), and [Scripts And Prompts](/en/outbound-calls/scripts-and-prompts).
</Tip>
