...
title: "Core Concepts"
icon: "lightbulb"
description: "Learn the fundamental building blocks of Famulor.io, including system prompts, voices, and AI assistants"
keywords: ["Famulor core concepts", "system prompt", "AI voice", "AI assistant", "voice agent basics", "voice AI fundamentals", "Famulor architecture"]
---

Welcome to the fundamentals of Famulor.io. Here, we explore the essential building blocks that you need to understand before configuring your AI assistant and calls.
...
- Famulor.io integrates with **ElevenLabs** voices for natural-sounding speech.
...
- Learn how [call minutes and billing](/en/getting-started/understanding-billing) work to plan your usage.
- Or, jump to [AI Assistants Overview](/en/ai-assistants/what-is-ai-assistant) to start building your first assistant.
