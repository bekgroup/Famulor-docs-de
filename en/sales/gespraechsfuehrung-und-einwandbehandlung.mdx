...
<Tip>
Value and next steps must always be clear. Keep objection-handling snippets ready in your script: [/outbound-calls/scripts-and-prompts](/en/outbound-calls/scripts-and-prompts)
</Tip>
