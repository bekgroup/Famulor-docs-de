...
icon: "calendar"
description: "Troubleshoot common Cal.com integration issues in Famulor: failed bookings, OAuth errors and event-type mismatches during AI voice agent appointments."
---

> Troubleshoot common Cal.com integration issues
...
- Define an email variable in [Assistant Prompt & Tools](/en/ai-assistants/prompt-and-tools)
...
- Each calendar should have a different event selected
- Use distinct event names (for example, `15min`, `30min`)
...
- [Cal.com Scheduling Setup](/en/ai-assistants/cal-com-scheduling)
