...
4. **Assistant Not Responding or Missing Speech in Transcript**
   - Disable noise cancellation in [Assistant Settings](/en/ai-assistants/general-settings)
   - Noise cancellation can sometimes filter speech too aggressively
   - Test again with noise cancellation turned off
