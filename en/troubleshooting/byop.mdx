...
icon: "phone-flip"
description: "Learn how to use your existing phone numbers or Twilio account with Famulor.io through SIP integration or Caller ID verification"
---

## 1. Bring Your Own Number (SIP Integration)

- **Yes**: If you have a PBX or VOIP provider, you can integrate via SIP trunk.
- Inbound & outbound will flow through your existing lines, but still utilize Famulor.io's AI.
...
- Meanwhile, you can have the best of both worlds by provisioning Twilio-based numbers through Famulor.io or using a custom approach.
...
<Tip>
Related pages: [Setup Issues](/en/troubleshooting/setup-issues) and [AI Behavior](/en/troubleshooting/ai-behavior), and [Call Quality](/en/troubleshooting/call-quality).
</Tip>
