...
description: "Understand the technical flow of how Famulor.io processes and handles phone conversations using AI"
keywords: ["how Famulor works", "AI phone flow", "voice AI architecture", "LLM telephony", "speech to text", "TTS", "AI conversation flow", "real-time voice AI"]
---

famulor.de blends **AI voice recognition** with **LLM-based replies** to conduct live phone conversations. Below is a simplified flow:

1. **Caller or Lead is Dialed**

   - **Inbound**: A customer dials your assigned phone number.
   - **Outbound**: Famulor.io's system calls a list of phone numbers from your campaign.

2. **Speech Recognition**  
   The AI listens to what the person says and transcribes it into text in real time.

3. **LLM Decision**  
   Famulor.io uses a large language model (LLM) and your configured "system prompt" to craft a reply or decide the next action (like transferring the call).
...
- Learn about [**Key Terminology**](/en/introduction/key-terminology) (like "AI Assistant," "Campaign," etc.).
- Jump into [**Getting Started**](/en/getting-started) to set up your first AI assistant.
