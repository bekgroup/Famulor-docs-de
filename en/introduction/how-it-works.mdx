...
description: "Understand the technical flow of how famulor.de processes and handles phone conversations using AI"
---
...
1. **Caller or Lead is Dialed**
   ...
   - **Outbound**: famulor.de's system calls a list of phone numbers from your campaign.

2. **Speech Recognition**  
   The AI listens to what the person says and transcribes it into text in real time.

3. **LLM Decision**  
   famulor.de uses a large language model (LLM) and your configured "system prompt" to craft a reply or decide the next action (like transferring the call).
