...
icon: "book-open"
keywords: ["voice AI glossary", "Famulor definitions", "AI telephony terms", "voice agent glossary", "speech-to-text", "TTS", "LLM", "conversational AI"]
---
...
See [mid-call tools](/en/automation-platform/mid-call-tools/was-sind-mid-call-tools). For whole external toolsets (HubSpot, CRM, APIs) connected in one step, see [MCP Servers](/en/platform/mcp-servers).
