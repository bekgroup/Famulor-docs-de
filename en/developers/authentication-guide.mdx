...
<Info>
For a quick reference, see our [basic authentication page](/api-reference/authentication) in the API reference.
</Info>
...
<CardGroup cols={2}>
  <Card title="Make Your First Call" icon="phone" href="/api-reference/calls/make">
    Learn how to implement API calls for voice agents
  </Card>
  <Card title="Webhook Integration" icon="link" href="/api-reference/webhooks/post-call">
