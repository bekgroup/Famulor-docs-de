...
<Info>
Für eine schnelle Referenz siehe unsere [grundlegende Authentifizierungsseite](/en/api-reference/authentication) in der API-Referenz.
</Info>
...
<CardGroup cols={2}>
  <Card title="Ersten Anruf tätigen" icon="phone" href="/en/api-reference/calls/make">
    Lernen Sie, wie Sie API-Aufrufe für Voice Agents implementieren
  </Card>
  <Card title="Webhook-Integration" icon="webhook" href="/en/api-reference/webhooks/post-call">
