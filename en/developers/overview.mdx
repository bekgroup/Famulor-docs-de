...
<CardGroup cols={2}>
  ...
  <Card title="No-Code Automatisierung" icon="wand-magic-sparkles" href="/en/automation-platform/introduction">
...
<Card title="API Anruf-Dokumentation" icon="phone" href="/en/api-reference/calls/make">
...
<Card title="Automatisierung Tutorial" icon="magic-wand" href="/en/automation-platform/tutorials/outbound-form-call">
...
<Card title="Vollständige Authentifizierungs-Anleitung" icon="key" href="/en/api-reference/authentication">
...
<CardGroup cols={2}>
  <Card title="API Referenz" icon="book" href="/en/api-reference/introduction">
    Vollständige API-Dokumentation mit Beispielen
  </Card>
  <Card title="Automatisierungsplattform" icon="flow" href="/en/automation-platform/introduction">
    No-Code-Workflow-Erstellung für Voice Agents
  </Card>
  <Card title="Integration Beispiele" icon="puzzle-piece" href="/en/automation-platform/integrations/overview">
    Vorgefertigte Integrationen für beliebte Tools
  </Card>
  <Card title="Webhooks" icon="webhook" href="/en/api-reference/webhooks/post-call">
...
1. **[API-Schlüssel erstellen](/en/api-reference/authentication)** - Authentifizierung einrichten
2. **[Ersten Anruf tätigen](/en/api-reference/calls/make)** - API-Integration testen
3. **[Automatisierung erkunden](/en/automation-platform/introduction)** - No-Code-Workflows erstellen
4. **[Integrationen konfigurieren](/en/automation-platform/integrations/overview)** - Business-Tools verbinden
