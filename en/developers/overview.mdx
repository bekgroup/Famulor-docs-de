...
<Card title="API Call Documentation" icon="phone" href="/api-reference/calls/make">
...
<Card title="Automation Tutorial" icon="wand-magic-sparkles" href="/automation-platform/tutorials/outbound-form-call">
...
<Card title="Complete Authentication Guide" icon="key" href="/api-reference/authentication">
...
<CardGroup cols={2}>
  ...
  <Card title="Automation Platform" icon="diagram-project" href="/automation-platform/introduction">
    No-code workflow creation for Voice Agents
  </Card>
  <Card title="Integration Examples" icon="puzzle-piece" href="/automation-platform/integrations/overview">
    Prebuilt integrations for popular tools
  </Card>
  <Card title="Webhooks" icon="link" href="/api-reference/webhooks/post-call">
...
1. **[Create an API key](/api-reference/authentication)** – Set up authentication  
2. **[Make your first call](/api-reference/calls/make)** – Test API integration  
3. **[Explore automation](/automation-platform/introduction)** – Build no-code workflows  
4. **[Configure integrations](/automation-platform/integrations/overview)** – Connect business tools  
