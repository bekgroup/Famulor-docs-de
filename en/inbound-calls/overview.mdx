...
When someone dials your dedicated (or SIP-integrated) number, Famulor.io can answer automatically through an AI Assistant. This section covers the big-picture flow of inbound calling:
...
<Tip>
Related pages: [Configuring](/en/inbound-calls/configuring), and [Insights](/en/inbound-calls/insights).
</Tip>
