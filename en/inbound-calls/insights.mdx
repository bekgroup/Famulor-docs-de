...
After an inbound call, Famulor.io provides transcripts, analytics, and possible automation triggers.
...
- In your Famulor.io dashboard, go to **Calls** or **History**.
...
<Tip>
Related pages: [Overview](/en/inbound-calls/overview), and [Configuring](/en/inbound-calls/configuring).
</Tip>
