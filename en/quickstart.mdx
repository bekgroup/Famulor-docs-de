---
title: "Quickstart"
description: "Get started with Famulor in minutes. Set up your first AI voice agent, configure phone numbers, and launch inbound or outbound calls with a step-by-step guide."
keywords: ["Famulor quickstart", "AI voice agent setup", "getting started", "phone number setup", "AI phone assistant", "voice AI tutorial", "Famulor onboarding"]
---
...
<Card title="Add code examples" icon="code" href="/en/essentials/code">
