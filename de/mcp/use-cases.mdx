...
Der [Famulor MCP Server](/de/mcp/server) und der [Famulor Skill](/de/mcp/famulor-skill) machen deine gesamte Plattform per natürlicher Sprache steuerbar. Diese Seite zeigt, was damit im Alltag möglich ist — gruppiert nach Anwendungsfall, mit Prompts zum Kopieren.
