...
description: "Verstehen Sie den technischen Ablauf, wie Famulor.io Telefongespräche mit KI verarbeitet und bearbeitet"
...
1. **Anrufer oder Lead wird gewählt**
   ...
   - **Ausgehend**: Famulor.io's System ruft eine Liste von Telefonnummern aus Ihrer Kampagne an.

2. **Spracherkennung**  
   Die KI hört zu, was die Person sagt, und transkribiert es in Echtzeit in Text.

3. **LLM-Entscheidung**  
   Famulor.io verwendet ein großes Sprachmodell (LLM) und Ihren konfigurierten "System-Prompt", um eine Antwort zu formulieren oder die nächste Aktion zu entscheiden (wie die Weiterleitung des Anrufs).
...
<Note>
Bereit für die Praxis? Beginnen Sie mit [Grundkonzepte](/de/getting-started/core-concepts) oder springen Sie direkt zur [Assistenten-Erstellung](/de/ai-assistants/creating-and-editing).
</Note> 