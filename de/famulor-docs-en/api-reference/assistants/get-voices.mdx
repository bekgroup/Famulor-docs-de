...
<ResponseField name="data" type="array">
  <Expandable title="properties">
    ...
    <ResponseField name="synthesizer_provider_id" type="integer">
      The TTS provider ID this voice belongs to. Use the [Get Synthesizer Providers](/api-reference/assistants/synthesizer-providers) endpoint to resolve provider names. May be `null`.
    </ResponseField>
  </Expandable>
</ResponseField>
