...
Lerne, wie du jeden Widget-Typ mit detaillierten Erklärungen aller Optionen konfigurierst.

## Widgets erstellen

1. Zum individuellen Dashboard navigieren
2. Klicke auf **"Widgets verwalten"** dann **"Neues Widget erstellen"**
...
Visualisiere Trends mit 8 Diagrammtypen.
...
Verwende beschreibende interne Namen:
...
<Note>
Für Dashboard-Erstellung und Layout-Verwaltung siehe [Übersicht individuelle Dashboards](/de/custom-dashboards/overview).
</Note>
