...
<Card title="Automatisierung Tutorial" icon="wand-magic-sparkles" href="/automation-platform/tutorials/outbound-form-call">
...
<CardGroup cols={2}>
  ...
  <Card title="Automatisierungsplattform" icon="diagram-project" href="/automation-platform/introduction">
