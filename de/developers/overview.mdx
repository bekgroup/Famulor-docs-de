...
icon: "code"
description: "Deploye KI-Voice-Agents über die leistungsstarke Famulor API. Verwalte Assistenten, Leads, Anrufe, Kampagnen, Wissensdatenbanken und Webhooks programmatisch."
keywords: ["Famulor Entwickler", "Voice AI API", "REST API", "Webhooks", "SDK", "Voice Agent Deployment", "Entwicklerhandbuch", "KI-Telefon API"]
---


# Famulor Developer Documentation

Willkommen zur Famulor Developer Documentation! Hier findest du alles, was du benötigst, um Voice Agents mit Famulor zu erstellen und zu deployen.

## Einführung

Famulor bietet dir leistungsstarke Tools zur Integration von KI-gesteuerten Voice Agents in deine Anwendungen. Mit unserer API und Automatisierungsplattform kannst du:
...
<CardGroup cols={2}>
  ...
  <Card title="No-Code Automatisierung" icon="wand-magic-sparkles" href="/de/automation-platform/introduction">
...
<Card title="API Anruf-Dokumentation" icon="phone" href="/de/api-reference/calls/make">
...
<Card title="Automatisierung Tutorial" icon="wand-magic-sparkles" href="/de/automation-platform/tutorials/outbound-form-call">
...
<Steps>
  <Step title="API-Schlüssel erhalten">
    Melde dich bei [deinem Famulor Dashboard](https://app.famulor.de) an und navigiere zur "API-Schlüssel" Seite
  </Step>
  <Step title="Schlüssel sicher speichern">
    Kopiere den API-Schlüssel und speichere ihn sicher in deinen Umgebungsvariablen
  </Step>
  <Step title="In Anfragen verwenden">
    Füge den Schlüssel im `Authorization: Bearer YOUR_API_KEY` Header hinzu
  </Step>
</Steps>

<Warning>
Halte deinen API-Schlüssel vertraulich und committe ihn niemals in Versionskontrollsysteme.
</Warning>

<Card title="Vollständige Authentifizierungs-Anleitung" icon="key" href="/de/api-reference/authentication">
  Detaillierte Informationen zur API-Authentifizierung
</Card>

## Quick Start: Dein erster Anruf

```bash
# 1. API-Schlüssel setzen (ersetze YOUR_API_KEY)
...
<CardGroup cols={2}>
  ...
  <Card title="Automatisierungsplattform" icon="diagram-project" href="/de/automation-platform/introduction">
    No-Code-Workflow-Erstellung für Voice Agents
  </Card>
  <Card title="Integration Beispiele" icon="puzzle-piece" href="/de/automation-platform/integrations/overview">
    Vorgefertigte Integrationen für beliebte Tools
  </Card>
  <Card title="Webhooks" icon="link" href="/de/api-reference/webhooks/post-call">
...
1. **[API-Schlüssel erstellen](/de/api-reference/authentication)** - Authentifizierung einrichten
2. **[Ersten Anruf tätigen](/de/api-reference/calls/make)** - API-Integration testen
3. **[Automatisierung erkunden](/de/automation-platform/introduction)** - No-Code-Workflows erstellen
4. **[Integrationen konfigurieren](/de/automation-platform/integrations/overview)** - Business-Tools verbinden

<Tip>
Beginne mit der Automatisierungsplattform, wenn du komplexere Geschäftsprozesse abbilden möchtest. Nutze die direkte API für einfache, programmatische Integrationen.
</Tip>