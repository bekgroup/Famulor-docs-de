...
<CardGroup cols={2}>
  ...
  <Card title="Zweckbindung" icon="bullseye">
...
<CardGroup cols={2}>
  ...
  <Card title="Öffentliche Information" icon="bullhorn">
...
<Info>
**Empfehlung:** Lass dich bei komplexen Voice Cloning-Projekten rechtlich beraten, um alle Compliance-Anforderungen zu erfüllen.
</Info>

<Tip>
Passende Seiten: [Data Retention](/de/legal/data-retention) und [Voice Cloning Legal Information](/de/legal/voice-cloning-legal-information).
</Tip>
