...
<CodeGroup>
```bash cURL
curl -X POST "https://app.famulor.de/api/user/ai/generate-reply" \
...
const response = await fetch("https://app.famulor.de/api/user/ai/generate-reply", {
  method: "POST",
  headers: {
...
response = requests.post(
    "https://app.famulor.de/api/user/ai/generate-reply",
    headers={
        "Content-Type": "application/json",
        "Authorization": "Bearer YOUR_API_TOKEN",
    },
