...
description: "Erstelle eine neue Outbound-Anrufkampagne in Famulor per API. Weise einen KI-Voice-Agent zu, lade Leads hoch und starte automatisierte Anrufe."
---

Dieser Endpunkt ermöglicht es dir, eine neue Outbound-Anrufkampagne mit der angegebenen Konfiguration zu erstellen.
...
<ParamField body="timezone" type="string">
  Zeitzonen-Kennung für die Kampagne (z. B. `America/New_York`, `Europe/London`). Standard: Zeitzone deines Kontos.
</ParamField>

<ParamField body="max_calls_in_parallel" type="integer" default="3">
  Maximale Anzahl gleichzeitiger Anrufe. Minimum: 1. Maximum abhängig vom Parallel-Anruf-Limit deines Tarifs (bis 10).
</ParamField>
...
<ParamField body="goal_completion_variable" type="string">
  Name einer Boolean-Variable aus dem Post-Call-Schema deines Assistenten zur Erfassung der Zielerreichung. Maximal 255 Zeichen.
</ParamField>
