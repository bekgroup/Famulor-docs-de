...
description: "Erstellen Sie eine neue Outbound-Anrufkampagne in Famulor per API. Weisen Sie einen KI-Voice-Agent zu, laden Sie Leads hoch und starten Sie automatisierte Anrufe."
---
