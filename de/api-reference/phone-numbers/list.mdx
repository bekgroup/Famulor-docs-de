...
<Note>
Es gibt auch einen Legacy-Endpunkt `GET /user/phone-numbers`, der nur SMS-fähige Telefonnummern mit aktiven Abonnements zurückgibt. Verwende diesen `/all` Endpunkt, wenn du alle Telefonnummern benötigst, unabhängig von SMS-Fähigkeit oder Abonnementstatus.
</Note>
