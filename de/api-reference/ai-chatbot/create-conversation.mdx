...
- Fahre mit [`Send Message`](/de/api-reference/ai-chatbot/send-conversation) fort und hole den Verlauf mit [`Get Conversation`](/de/api-reference/ai-chatbot/get-conversation).
