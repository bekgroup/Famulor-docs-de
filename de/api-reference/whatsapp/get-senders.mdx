...
description: "Alle WhatsApp Business Sender (Absendernummern) deines Famulor-Kontos abrufen"
---
...
Dieser Endpunkt gibt eine Liste der WhatsApp Business Sender (Telefonnummern) zurück, die in deinem Famulor-Konto konfiguriert sind. Verwende diesen Endpunkt, um Sender-IDs zu erhalten, die du zum Versenden von Nachrichten benötigst.

### Query-Parameter

<ParamField query="status" type="string" optional>
  Sender nach Status filtern. Standard: `online`. Verwende `all`, um alle Sender unabhängig vom Status zurückzugeben.
</ParamField>
...
<ResponseField name="data" type="array">
  <Expandable title="Sender-Objekt Eigenschaften">
    <ResponseField name="id" type="integer">
      Die eindeutige Kennung des WhatsApp-Senders. Verwende diese ID beim Versenden von Nachrichten.
    </ResponseField>
