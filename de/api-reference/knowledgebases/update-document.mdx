...
Dieser Endpunkt aktualisiert die Metadaten eines bestehenden Dokuments. Du kannst nur den Namen und die Beschreibung aktualisieren - der Dokumenttyp und der Inhalt können nicht geändert werden.
...
<Note>
  Um den Inhalt eines Dokuments zu aktualisieren, musst du das bestehende Dokument löschen und ein neues mit dem aktualisierten Inhalt erstellen.
</Note>
