...
<ParamField body="file" type="file" required>
  Die hochzuladende Datei (max. 20MB). Verwende `multipart/form-data` Kodierung.
</ParamField>
...
<Note>
  Die Dokumentverarbeitung erfolgt asynchron. Rufe den [Dokument abrufen](/de/api-reference/knowledgebases/get-document) Endpunkt ab, um zu prüfen, wann die Verarbeitung abgeschlossen ist.
</Note>
