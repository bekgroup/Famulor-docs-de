...
<ParamField query="language_id" type="integer">
  Stimmen nach Sprach-ID filtern. Verwenden Sie den Endpunkt [Sprachen abrufen](/de/api-reference/assistants/languages), um verfügbare Sprach-IDs zu erhalten.
</ParamField>
...
<ResponseField name="data" type="array">
  <Expandable title="Eigenschaften">
    ...
    <ResponseField name="synthesizer_provider_id" type="integer">
      Die TTS-Provider-ID, zu der diese Stimme gehört. Verwenden Sie den Endpunkt [Synthesizer-Provider abrufen](/de/api-reference/assistants/synthesizer-providers), um Providernamen aufzulösen. Kann `null` sein.
    </ResponseField>
  </Expandable>
</ResponseField>
