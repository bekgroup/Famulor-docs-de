...
- Der Assistent hört auf, HTTP POST-Requests an deine Webhook-URL zu senden
...
- Du kannst später Webhooks mit einer neuen URL über den Enable Webhook Endpunkt wieder aktivieren
