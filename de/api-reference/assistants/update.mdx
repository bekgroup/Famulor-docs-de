...
Dieser Endpunkt ermöglicht es Ihnen, die Konfiguration eines bestehenden KI-Assistenten zu aktualisieren. Alle Felder sind optional – es werden nur die angegebenen Felder aktualisiert. Für ausführliche Feldbeschreibungen und Optionen siehe [Assistent erstellen](/de/api-reference/assistants/create).
...
<ParamField body="voice_id" type="integer">
  Die zu verwendende Stimmen-ID für den Assistenten. Verwenden Sie den Endpunkt [Stimmen abrufen](/de/api-reference/assistants/voices) mit dem Parameter `mode`, um kompatible Stimmen für Ihren Engine-Modus zu erhalten.
</ParamField>

<ParamField body="language_id" type="integer">
  Die Sprach-ID für den Assistenten. Verwenden Sie den Endpunkt [Sprachen abrufen](/de/api-reference/assistants/languages), um verfügbare Sprachen zu erhalten.
</ParamField>
...
<ParamField body="llm_model_id" type="integer">
  ...
  Verwenden Sie den Endpunkt [Modelle abrufen](/de/api-reference/assistants/models), um verfügbare Modelle zu erhalten.
</ParamField>

<ParamField body="multimodal_model_id" type="integer">
  Die multimodale Modell-ID. Gilt nur für die Modi `multimodal` und `dualplex`.

  Verwenden Sie den Endpunkt [Modelle abrufen](/de/api-reference/assistants/models), um verfügbare multimodale Modelle zu erhalten.
</ParamField>
...
<ParamField body="folder_id" type="integer">
  ID eines [Ordners](/de/api-reference/folders/create), in den dieser Assistent verschoben werden soll. Muss zu Ihrem Konto gehören. Auf `null` setzen, um ihn unkategorisiert zu machen. Weglassen, um den Ordner unverändert zu lassen.
</ParamField>

<ParamField body="label_ids" type="integer[]">
  Array von [Label](/de/api-reference/labels/create)-IDs für diesen Assistenten. Jedes Label muss zu Ihrem Konto gehören. Wenn angegeben, **ersetzt** dies die aktuellen Labels des Assistenten. Weglassen, um Labels unverändert zu lassen; `[]` senden, um alle Labels zu entfernen.
...
<ParamField body="tools" type="array">
  ...
  <Expandable title="Tool-Typen">
    ...
    * `assistant_id` (erforderlich): ID des Ziel-Assistenten. Muss zu Ihrem Konto gehören und darf nicht der aktualisierte Assistent selbst sein (kein Self-Transfer).
...
* Verwenden Sie den Endpunkt [Stimmen abrufen](/de/api-reference/assistants/voices) mit dem Parameter `mode`, um kompatible Stimmen zu erhalten
