...
* Verwende das Feld `llm_model_id`, wenn du **pipeline** Assistenten erstellst
* Verwende das Feld `multimodal_model_id`, wenn du **multimodal** oder **dualplex** Assistenten erstellst
