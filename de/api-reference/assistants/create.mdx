...
<ParamField body="voice_id" type="integer" required>
  Die Voice-ID für den Assistenten. Verwende den Endpunkt [Stimmen abrufen](/de/api-reference/assistants/voices) mit dem Query-Parameter `mode`, um kompatible Stimmen für deinen Engine-Modus zu erhalten.
</ParamField>

<ParamField body="language_id" type="integer" required>
  Die Language-ID für den Assistenten. Verwende den Endpunkt [Sprachen abrufen](/de/api-reference/assistants/languages), um verfügbare Sprachen zu erhalten.
</ParamField>
...
<ParamField body="multimodal_model_id" type="integer">
  ...
  Verwende den Endpunkt [Modelle abrufen](/de/api-reference/assistants/models), um verfügbare Multimodal-Modelle zu erhalten.
</ParamField>
...
<ParamField body="folder_id" type="integer">
  ID eines [Ordners](/de/api-reference/folders/create), in den dieser Assistent eingeordnet werden soll. Muss zu deinem Konto gehören. Sende `null`, um den Assistenten unkategorisiert zu lassen.
</ParamField>

<ParamField body="label_ids" type="integer[]">
  Array von [Label](/de/api-reference/labels/create)-IDs, die diesem Assistenten zugewiesen werden sollen. Jedes Label muss zu deinem Konto gehören.
...
<ParamField body="tools" type="array">
  Array integrierter Tools. Jedes Tool hat ein `type`-Feld und tool-spezifische Felder. Bei [Assistent aktualisieren](/de/api-reference/assistants/update) **ersetzt dies alle bestehenden integrierten Tools** — übergib ein leeres Array `[]`, um alle Tools zu entfernen.
...
<ParamField body="synthesizer_provider_id" type="integer">
  Custom TTS Provider-ID. Wenn nicht gesetzt, wird anhand der Sprache automatisch ausgewählt. Siehe [Synthesizer-Provider abrufen](/de/api-reference/assistants/synthesizer-providers).
</ParamField>

<ParamField body="transcriber_provider_id" type="integer">
  Custom STT Provider-ID. Wenn nicht gesetzt, wird anhand der Sprache automatisch ausgewählt. Nur `pipeline`. Siehe [Transcriber-Provider abrufen](/de/api-reference/assistants/transcriber-providers).
</ParamField>
...
* Verwende den Endpunkt [Stimmen abrufen](/de/api-reference/assistants/voices) mit dem Query-Parameter `mode`, um kompatible Stimmen zu erhalten
