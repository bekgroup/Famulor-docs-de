...
api: "POST https://app.famulor.de/api/user/tools"
description: "Erstelle ein neues Mid-Call-Tool in Famulor per API. Gib deinen KI-Telefonassistenten neue Aktionen wie Buchung, CRM-Abfrage oder Webhook-Trigger."
---


Dieser Endpunkt ermöglicht es dir, ein neues Mid-Call-Tool zu erstellen, das von deinen KI-Assistenten verwendet werden kann, um während Anrufen mit externen APIs zu interagieren.
...
Nach dem Erstellen eines Tools musst du es einem Assistenten zuweisen, um es während Anrufen zu verwenden. Tools werden über die Assistenten-API verwaltet:

- **[Assistent erstellen](/de/api-reference/assistants/create)** - Verwende den `tool_ids`-Parameter, um Tools beim Erstellen eines Assistenten zuzuweisen
- **[Assistent aktualisieren](/de/api-reference/assistants/update)** - Verwende den `tool_ids`-Parameter, um Tools bei einem bestehenden Assistenten hinzuzufügen, zu entfernen oder zu ersetzen
