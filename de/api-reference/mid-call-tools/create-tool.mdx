...
description: "Erstellen Sie ein neues Mid-Call-Tool in Famulor per API. Geben Sie Ihren KI-Telefonassistenten neue Aktionen wie Buchung, CRM-Abfrage oder Webhook-Trigger."
---
...
- **[Assistent erstellen](/de/api-reference/assistants/create)** - Verwenden Sie den `tool_ids`-Parameter, um Tools beim Erstellen eines Assistenten zuzuweisen
- **[Assistent aktualisieren](/de/api-reference/assistants/update)** - Verwenden Sie den `tool_ids`-Parameter, um Tools bei einem bestehenden Assistenten hinzuzufügen, zu entfernen oder zu ersetzen
