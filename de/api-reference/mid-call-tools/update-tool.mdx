...
description: "Aktualisieren Sie eine bestehende Mid-Call Action in Famulor per API. Ändern Sie Name, Endpunkt, Parameter oder Beschreibung für Ihren KI-Telefonassistenten."
---
...
- **[Assistent aktualisieren](/de/api-reference/assistants/update)** - Verwenden Sie den `tool_ids`-Parameter, um zu verwalten, welche Tools einem Assistenten zugewiesen sind
