---
title: "Mid-call Action aktualisieren"
api: "PUT https://app.famulor.de/api/user/tools/{id}"
description: "Aktualisiere eine bestehende Mid-Call Action in Famulor per API. Ändere Name, Endpunkt, Parameter oder Beschreibung für deinen KI-Telefonassistenten."
---


Dieser Endpunkt ermöglicht es dir, ein bestehendes Mid-call Action zu aktualisieren. Alle Felder sind optional - gib nur die Felder an, die du aktualisieren möchtest.
...
Um dieses Tool zu Assistenten hinzuzufügen oder zu entfernen, verwende die Assistenten-API:
...
- **[Assistent aktualisieren](/de/api-reference/assistants/update)** - Verwende den `tool_ids`-Parameter, um zu verwalten, welche Tools einem Assistenten zugewiesen sind
