...
<Warning>
  ...
  **Empfehlung für Vonage:** Nutze die **Warmweiterleitung**. Dabei baut Famulor einen **separaten ausgehenden Anruf** zum Ansprechpartner über den Vonage-Trunk auf und verbindet beide Seiten – das benötigt **kein** REFER und funktioniert mit Vonage.
</Warning>
...
<AccordionGroup>
  ...
  <Accordion title="Kaltweiterleitung funktioniert nicht" icon="phone-arrow-up-right">
    **Vonage unterstützt kein SIP REFER**, das Famulor für die Kaltweiterleitung nutzt. Verwende stattdessen die **Warmweiterleitung** – sie baut einen separaten ausgehenden Anruf auf und funktioniert mit Vonage. Details: [Anrufsweiterleitung](/de/platform/anrufsweiterleitung).
  </Accordion>
</AccordionGroup>
