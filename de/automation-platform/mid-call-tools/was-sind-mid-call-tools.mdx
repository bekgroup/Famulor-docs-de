...
<CardGroup cols={3}>
  <Card title="Integration Templates ansehen" icon="clone" href="/automation-platform/mid-call-actions/integration-templates/hubspot-kontakt-abruf">
    Erkunden Sie vorgefertigte Templates für beliebte CRM-Systeme und Services
  </Card>
  <Card title="Webhook-Automation" icon="link" href="/automation-platform/mid-call-actions/integration-templates/webhook-automation">
