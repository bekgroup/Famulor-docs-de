...
description: "Verstehe, was Mid-call Actions sind und wie sie deine KI-Assistenten während aktiver Telefonate erweitern"
...
Mid-call Actions sind spezialisierte Funktionen, die während aktiver Telefongespräche ausgeführt werden und deinem KI-Assistenten ermöglichen, in Echtzeit auf externe Systeme und Datenquellen zuzugreifen. Diese Tools transformieren statische Gesprächsführung in dynamische, datengesteuerte Interaktionen.
...
<CardGroup cols={3}>
  ...
  <Card title="Datenqualität" icon="shield-halved">
...
<CardGroup cols={2}>
  ...
  <Card title="Webhook-Integration mit Famulor Automation" icon="link">
...
<Warning>
**Wichtiger Hinweis zur Datensicherheit**: Mid-call Actions verarbeiten sensible Kundendaten in Echtzeit. Stelle sicher, dass alle integrierten Systeme den geltenden Datenschutzbestimmungen (DSGVO) entsprechen.
</Warning>
...
<CardGroup cols={3}>
  <Card title="Integration Templates ansehen" icon="clone" href="/de/automation-platform/mid-call-tools/integration-templates/hubspot-kontakt-abruf">
    Erkunde vorgefertigte Templates für beliebte CRM-Systeme und Services
  </Card>
  <Card title="Webhook-Automation" icon="link" href="/de/automation-platform/mid-call-tools/integration-templates/webhook-automation">
    Entdecke komplexe Multi-System-Workflows über die Famulor Automation Platform
  </Card>
  <Card title="Eigene Tools erstellen" icon="code" href="/de/automation-platform/mid-call-tools/custom-api-integration">
    Lerne, wie du maßgeschneiderte Mid-call Actions für deine spezifischen Anforderungen entwickelst
  </Card>
</CardGroup>
...
<Info>
**Tipp**: Beginne mit einfachen Read-Only-Integrationen (z.B. Kontaktdatenabfrage) bevor du komplexere Write-Operationen (z.B. Lead-Erstellung) implementierst.
</Info>
