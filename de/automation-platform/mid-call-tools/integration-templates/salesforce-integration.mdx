...
Integriere deine Mid-call Actions mit Salesforce, dem weltweit führenden CRM-System. Diese Integration bietet umfangreiche Möglichkeiten für Enterprise-Workflows, komplexe Sales-Prozesse und skalierbares Customer-Relationship-Management.
...
<Steps>
  <Step title="Setup-Navigation">
    - Melde dich bei Salesforce als Admin an
    - Geh zu "Setup" (Zahnrad-Symbol)
    - Navigiere zu "Apps" → "App Manager"
  </Step>
...
Erweitere deine Salesforce-Integration:

- [HubSpot Integration](/de/automation-platform/mid-call-tools/integration-templates/hubspot-kontakt-abruf) für CRM-Vergleiche
- [Webhook-Integration](/de/automation-platform/mid-call-tools/integration-templates/webhook-automation) für Multi-System-Workflows
...
<Warning>
**Compliance-Hinweis**: Bei Enterprise-Salesforce-Integrationen musst du ggf. spezielle Compliance-Anforderungen (SOX, HIPAA, etc.) beachten. Konsultiere dein Compliance-Team vor der Implementierung.
</Warning>

<Info>
**Skalierungs-Tipp**: Beginne mit Standard-Objects (Lead, Contact, Opportunity) und erweitere schrittweise um Custom-Objects und Advanced-Features. Salesforce bietet umfangreiche Sandbox-Umgebungen für sicheres Testing.
</Info>
