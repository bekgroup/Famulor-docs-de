...
Integriere Jira Issue-Tracking in deine Mid-call Actions mit drei leistungsstarken Funktionen: Issues suchen, aktualisieren und erstellen. Perfekt für DevOps-Teams, Support-Organisationen und agile Entwicklungsprozesse.
...
<Steps>
  <Step title="Jira Cloud Instance vorbereiten">
    ...
    - Notiere deine Jira-Instance-URL: `https://ihrefirma.atlassian.net`
  ...
  <Step title="Projekt-Keys identifizieren">
    - Navigiere zu deinen Jira-Projekten
...
<Warning>
**Jira-Permissions**: Stelle sicher, dass der verwendete API-User Berechtigung für alle relevanten Projekte hat und Custom Fields lesen/schreiben kann. Überprüfe regelmäßig die Workflow-Permissions.
</Warning>

<Info>
**JQL-Performance-Tipp**: Verwende spezifische Project-Keys und Date-Ranges in JQL-Queries, um die Performance zu optimieren. Vermeide sehr breite Suchen ohne Filter.
</Info>
