...
Integriere Asana-Task-Management in deine Mid-call Actions und ermögliche es deinem KI-Assistenten, während Kundengesprächem automatisch Aufgaben zu erstellen, zu zuweisen und Projekte zu koordinieren - perfekt für agile Teams und Projektmanagement.
...
<Steps>
  <Step title="Asana Account & Workspace">
    - Stelle sicher, dass du Admin-Rechte in deinem Asana-Workspace hast
    - Navigiere zu "Admin Console" → "Apps" → "Service accounts"
    - Oder verwende Personal Access Tokens für einfacheres Setup
  </Step>
  
  <Step title="Personal Access Token erstellen">
    ```yaml
    Token-Generation:
      1. Klicke auf dein Profilbild → "My Settings"
...
<Warning>
**Workspace-Zugriff**: Stelle sicher, dass alle automatisch erstellten Tasks von den zugewiesenen Team-Mitgliedern gesehen und bearbeitet werden können. Überprüfe regelmäßig die Projekt-Berechtigungen.
</Warning>

<Info>
**Produktivitäts-Tipp**: Verwende Asana-Templates für wiederkehrende Task-Typen (Sales Follow-up, Support-Eskalation, etc.) um Konsistenz und Effizienz zu maximieren.
</Info>
