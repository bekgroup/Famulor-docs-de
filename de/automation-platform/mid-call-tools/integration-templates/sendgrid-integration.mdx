...
Integriere SendGrid E-Mail-Versand in deine Mid-call Actions und ermögliche es deinem KI-Assistenten, während Kundengesprächem automatisch personalisierte E-Mails zu versenden - ideal für Follow-ups, Bestätigungen und Marketing-Kommunikation.
...
<Steps>
  <Step title="SendGrid Account erstellen">
    - Registriere dich bei [SendGrid](https://sendgrid.com)
    - Wähle einen passenden Plan (Free Plan für bis zu 100 E-Mails/Tag)
    - Verifiziere deine E-Mail-Adresse und deinen Account
  </Step>
  ...
  <Step title="Sender Authentication">
    ...
    Domain-Authentifizierung (empfohlen):
      ...
      3. DNS-Einträge bei deinem Domain-Provider hinzufügen
...
<CardGroup cols={2}>
  <Card title="Einverständnis-Management" icon="shield-halved">
...
<Warning>
**DSGVO-Compliance**: Stelle sicher, dass du für alle E-Mail-Sendungen eine rechtsgültige Einverständniserklärung hast und alle Datenschutzbestimmungen einhältst.
</Warning>

<Info>
**Performance-Tipp**: Verwende SendGrid Dynamic Templates für konsistente Formatierung und bessere Personalisierung. Teste verschiedene Subject Lines für optimale Open Rates.
</Info>
