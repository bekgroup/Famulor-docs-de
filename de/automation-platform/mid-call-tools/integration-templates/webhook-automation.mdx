...
description: "Mid-call Actions über Webhooks mit der Famulor Automation Platform verbinden für erweiterte Workflow-Automatisierung"
icon: "link"
---
...
Mid-call Actions können nicht nur direkte API-Calls ausführen, sondern auch über Webhooks mit der Famulor Automation Platform verbunden werden. Dies ermöglicht komplexe, mehrstufige Workflows und die Nutzung aller verfügbaren Integrationen der No-Code-Plattform.

## Überblick der Webhook-Integration

<CardGroup cols={2}>
  <Card title="Direkte API vs. Webhook" icon="code-branch">
...
<Tabs>
  <Tab title="Tool-Setup">
    ...
    | **Beschreibung** | "Startet einen Famulor Automation-Workflow mit Gesprächsdaten als Input. Verwende dies für komplexe Multi-System-Operationen." |
    | **HTTP-Methode** | `POST` |
...
Trigger: Webhook von Mid-call Action
...
Entdecke praktische Webhook-Workflow-Beispiele:

- [HubSpot Integration](/de/automation-platform/mid-call-tools/integration-templates/hubspot-kontakt-abruf) für CRM-Automatisierung
- [Slack Integration](/de/automation-platform/mid-call-tools/integration-templates/slack-integration) für Team-Benachrichtigungen
- [SendGrid Integration](/de/automation-platform/mid-call-tools/integration-templates/sendgrid-integration) für E-Mail-Automation
</Card>

<Info>
**Tipp**: Beginne mit einfachen Webhook-Workflows und erweitere schrittweise. Die Famulor Automation Platform bietet umfangreiche Debugging-Tools, um Workflow-Executions zu verfolgen und zu optimieren.
</Info>

<Warning>
**Wichtiger Hinweis**: Webhook-Workflows können komplexe Geschäftsprozesse automatisieren. Teste alle Workflows ausführlich in einer Staging-Umgebung, bevor du sie in der Produktion einsetzt.
</Warning>
