...
Integriere Slack-Messaging in deine Mid-call Actions und ermögliche es deinem KI-Assistenten, während Kundengesprächem automatisch Nachrichten, Benachrichtigungen und Updates an die relevanten Team-Channels zu senden.
...
<Steps>
  <Step title="Workspace Admin-Zugang">
    - Melde dich als Workspace-Admin bei Slack an
    - Navigiere zu [api.slack.com/apps](https://api.slack.com/apps)
  ...
  <Step title="App-Konfiguration">
    ...
    App-Details:
      ...
      Development Workspace: [Dein Workspace]
...
<Tabs>
  <Tab title="Werkzeugdetails">
    ...
    | **Funktionsbeschreibung*** | "Sendet eine Nachricht an einen Slack-Channel. Verwende dies für Team-Benachrichtigungen, Lead-Alerts oder wichtige Updates während des Gesprächs." |
    | **HTTP-Methode** | `POST` |
    | **Timeout (ms)** | `5000` |
...
<Warning>
**Datenschutz-Hinweis**: Stelle sicher, dass sensible Kundendaten nur in privaten Channels geteilt werden und dein Slack-Workspace den Unternehmens-Compliance-Richtlinien entspricht.
</Warning>

<Info>
**Pro-Tipp**: Beginne mit einem dedizierten Test-Channel für die Slack-Integration, bevor du sie in produktiven Channels verwendest. Dies hilft beim Fine-Tuning der Nachrichten-Templates und -Frequenz.
</Info>
