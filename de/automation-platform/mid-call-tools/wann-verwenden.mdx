---
title: "Wann Mid-call Actions verwenden?"
description: "Erfahre, in welchen Szenarien Mid-call Actions den größten Mehrwert bieten und wann du sie einsetzen solltest"
icon: "lightbulb"
---


# Wann solltest du Mid-call Actions verwenden?

Mid-call Actions bieten den größten Mehrwert, wenn deine KI-Assistenten während Gesprächen auf externe Daten zugreifen müssen. Diese Seite hilft dir zu identifizieren, wann der Einsatz sinnvoll ist und welche Szenarien am besten geeignet sind.
...
<CardGroup cols={2}>
  ...
  <Card title="Bestellstatus-Abfragen" icon="box">
...
## Situationen, wo Mid-call Actions NICHT geeignet sind

### Vermeide den Einsatz bei:

<Warning>
**Einfache Informationsabfragen**: Wenn die benötigten Informationen statisch sind und sich selten ändern (z.B. Öffnungszeiten, allgemeine Firmeninfos), ist ein Mid-call Action überdimensioniert.
</Warning>
...
### Decision Tree für Mid-call Action-Einsatz

```mermaid
flowchart TD
    A[Benötigst du externe Daten?] --> B{Ja}
    A --> C{Nein}
...
<CardGroup cols={2}>
  <Card title="Template-Bibliothek erkunden" icon="clone" href="/de/automation-platform/mid-call-tools/integration-templates/hubspot-kontakt-abruf">
    Starte mit bewährten Integration-Templates für beliebte CRM-Systeme
  </Card>
  <Card title="Custom Integration planen" icon="code" href="/de/automation-platform/mid-call-tools/custom-api-integration">
    Entwickle maßgeschneiderte Lösungen für deine spezifischen Anforderungen
  </Card>
</CardGroup>
...
<Tip>
**Best Practice**: Beginne immer mit einem einfachen, risikoarmen Use Case und erweitere schrittweise. Miss kontinuierlich die Performance und Auswirkungen auf die Kundenerfahrung.
</Tip>
