...
description: "Erfahren Sie, in welchen Szenarien Mid-call Actions den größten Mehrwert bieten und wann Sie sie einsetzen sollten"
icon: "lightbulb"
---


# Wann sollten Sie Mid-call Actions verwenden?

Mid-call Actions bieten den größten Mehrwert, wenn Ihre KI-Assistenten während Gesprächen auf externe Daten zugreifen müssen. Diese Seite hilft Ihnen zu identifizieren, wann der Einsatz sinnvoll ist und welche Szenarien am besten geeignet sind.
