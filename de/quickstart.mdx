---
title: "Quickstart"
description: "Starten Sie mit Famulor in wenigen Minuten. Richten Sie Ihren ersten KI-Voice-Agent ein, konfigurieren Sie Telefonnummern und starten Sie Inbound- oder Outbound-Anrufe."
keywords: ["Famulor Quickstart", "KI-Voice-Agent Setup", "Erste Schritte", "Telefonnummer einrichten", "KI-Telefonassistent", "Voice AI Tutorial", "Famulor Onboarding"]
---
...
<Card title="Write Content" icon="pen-to-square" href="/de/essentials/markdown">
  Learn MDX syntax and start writing your documentation.
</Card>

<Card title="Customize style" icon="palette" href="/de/essentials/settings">
  Make your docs match your brand perfectly.
</Card>

<Card title="Add code examples" icon="code" href="/de/essentials/code">
  Include syntax-highlighted code blocks.
</Card>

<Card title="API documentation" icon="code" href="/de/api-reference/introduction">
