---
title: 'Development'
description: "Sieh dir Änderungen an deiner Famulor-Dokumentation lokal in der Vorschau an. Installiere die Mintlify CLI und starte einen Live-Dev-Server."
