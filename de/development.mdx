---
title: 'Development'
description: "Sehen Sie Änderungen an Ihrer Famulor-Dokumentation lokal in der Vorschau an. Installieren Sie die Mintlify CLI und starten Sie einen Live-Dev-Server."
keywords: ["Famulor Docs Development", "Mintlify CLI", "Lokale Vorschau", "Docs Setup", "Dev Server", "Dokumentations-Workflow"]
---
