...
Begriffe wie LLM, STT, TTS, SIP-Trunk oder Realtime-Modelle findest du im [Glossar](/de/glossary).
...
| **No-Training-Garantie** | Wir stellen vertraglich sicher, dass keiner unserer KI-Anbieter deine Daten (Audio, Transkripte oder Prompts) zum Trainieren oder Verbessern seiner Basismodelle nutzen darf. |
...
Transparenz über die Systemperformance ist uns in der Zusammenarbeit wichtig. Unseren Live-Status kannst du jederzeit einsehen:
...
| [Twilio Ireland Limited](https://www.twilio.com/docs/global-infrastructure/send-an-sms-with-twilio-regions) | Telefonie, SIP Trunk, SMS und WhatsApp Business Messaging | Irland (EU). Regionale Verarbeitung über Twilio Regions (u. a. IE1). |
...
| Meta (Pixel API & WhatsApp Business Platform) | Meta Platforms Ireland Limited | 4 Grand Canal Square, Grand Canal Harbour, Dublin 2, Irland | [Meta Business Tools Terms](https://www.facebook.com/legal/technology_terms) |
...
Für alle Anbieter ohne DPF-Zertifizierung (Deepgram, Soniox, Gladia, Cartesia, LiveKit) hat Famulor die EU-Standardvertragsklauseln gemäß Beschluss 2021/914/EU der EU-Kommission (Modul 2: Verantwortlicher an Auftragsverarbeiter) abgeschlossen. Diese sind Enterprise-Kunden auf Anfrage verfügbar.

Zur eigenständigen Prüfung der DPF-Zertifizierung einzelner Anbieter: [Data Privacy Framework Participants List](https://www.dataprivacyframework.gov/list)
...
Die Nutzung von Informationen aus Google APIs durch Famulor im Rahmen der Activepieces-Integration sowie deren Weitergabe an andere Anwendungen erfolgt gemäß der [Google API Services User Data Policy](https://developers.google.com/terms/api-services-user-data-policy), einschließlich der Anforderungen zur Limited Use.
