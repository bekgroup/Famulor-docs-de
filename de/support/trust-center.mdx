...
Begriffe wie LLM, STT, TTS, SIP-Trunk oder Realtime-Modelle finden Sie im [Glossar](/de/glossary).
...
Die Nutzung von Informationen aus Google APIs durch Activepieces sowie deren Weitergabe an andere Anwendungen erfolgt gemäß der [Google API Services User Data Policy](https://developers.google.com/terms/api-services-user-data-policy), einschließlich der Anforderungen zur Limited Use.
