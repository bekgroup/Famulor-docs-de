...
|----------|-----------|----------------|----------------------|
| [Deepgram, Inc.](https://deepgram.com/learn/deepgram-eu-endpoint-now-generally-available) | STT | Speech-to-Text (Nova/Flux API) | EU-Endpunkt verfügbar (`api.eu.deepgram.com`); DSGVO-konforme Nutzung über EU-Region möglich. |
...
| [Twilio Ireland Limited](https://www.twilio.com/docs/global-infrastructure/send-an-sms-with-twilio-regions) | Telefonie, SIP Trunk und SMS (Programmable Messaging) | Irland (EU). Regionale Verarbeitung über Twilio Regions (u. a. IE1) möglich. |
