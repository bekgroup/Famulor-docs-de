...
description: "Entdecke die integrierten Tools und Funktionen, die die Fähigkeiten deines KI-Assistenten während Anrufen erweitern"
---


Famulor bietet integrierte "Tools", die dein KI-Assistent während eines Anrufs verwenden kann. Diese helfen dir, den Gesprächsverlauf zu gestalten und Aktionen wie Anrufweiterleitung oder Terminplanung zu automatisieren.

## 1. Anruf beenden Tool

- **Zweck**: Sagt der KI, höflich das Gespräch zu beenden.
- **Wie es funktioniert**: Du kannst im System-Prompt oder in der Logik spezifizieren, zum Beispiel: "Wenn der Benutzer `auf Wiedersehen` sagt, beenden Sie den Anruf."
- **Konfiguration**: In den Assistenten-Einstellungen kannst du alle Bedingungen definieren, die das Beenden des Anrufs auslösen sollten.
...
- **Supervisor Telefonnummer**: Die Telefonnummer, die für die Warm-Weiterleitung gewählt wird. Optional kannst du eine benutzerdefinierte SIP-Adresse oder interne Durchwahl aktivieren.
...
- **Caller ID für Supervisor**: Wähle, welche Telefonnummer der Supervisor beim Empfang des Anrufs sieht (z.B. Kunden-Telefonnummer).
- **Haltemusik**: Wähle die Audio-Datei, die während der Warteschleife abgespielt wird (Standard-Haltemusik oder benutzerdefiniert).
...
**Mehrere Weiterleitungsziele**: Du kannst mehrere Warmanrufweiterleitungsziele für verschiedene Szenarien oder Abteilungen hinzufügen.
...
- **Zweck**: Lässt die KI deine Kalenderverfügbarkeit überprüfen (z.B. über Cal.com oder Google Calendar) und einen Termin buchen.
- **Typischer Ablauf**:
...
- **Einrichtung**: Verknüpfe deinen Assistenten mit dem "Automatisierung"-Tab, wähle Trigger ("Anruf beendet," "Kunde stimmt zu," etc.) und wähle die Aktion (Slack-Benachrichtigung senden oder Zeile in Sheets hinzufügen).
...
Definiere, wann und wie Tools verwendet werden
</Card>
<Card title="Cal.com Scheduling" icon="calendar" href="/de/ai-assistants/cal-com-scheduling">
Integriere Terminplanung in deine Anrufe
</Card>
</CardGroup>

<CardGroup cols={2}>
<Card title="Custom Mid-Call Tools" icon="code" href="/de/ai-assistants/custom-mid-call-tools">
Erstelle benutzerdefinierte Tools für spezielle Anwendungsfälle
</Card>
...
<Note>
Für erweiterte Tool-Konfiguration siehe auch [Custom Mid-Call Tools](/de/ai-assistants/custom-mid-call-tools) und [Webhook-Integration](/de/automation/webhook-api).
</Note> 