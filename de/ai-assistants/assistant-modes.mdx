...
icon: "bolt"
description: "Verstehe die drei Sprachgenerierungsmodi für deine KI-Assistenten und wann du jeden verwenden solltest"
---
...
- Du benötigst reichhaltige, mehrsätzige Antworten (z.B. Support-Anfragen, detaillierte Erklärungen)
- Der Assistent muss über strukturierte Daten oder komplexe Prompts reasoning betreiben
- Du bevorzugst absolute Kontrolle über die gesprochene Stimme (Klon- oder Markenstimme)
...
- Deine Antworten sind im Allgemeinen kurze Sätze oder schnelle Bestätigungen
- Du bist mit den systemseitig bereitgestellten Stimmoptionen für schnellere Interaktion einverstanden

<Info>
Speech-to-Speech entwickelt sich schnell weiter. Wenn du eine benutzerdefiniert geklonte Stimme mit niedriger Latenz benötigst, probiere Dualplex aus.
</Info>
...
- Du möchtest schnellen Dialog, benötigst aber eine Marken- oder geklonte Stimme
- Du wünschst dir ausdrucksstärkere Wiedergabe ohne Verzicht auf präzise Stimmauswahl
- Du bist mit der Nutzung neuer Funktionen vertraut, die sich noch in der Beta-Phase befinden

---

## Modi wechseln

Du kannst den Modus für jeden Assistenten unter **Assistent → Einstellungen → Voice Engine** auswählen. Teste alle drei Modi, um herauszufinden, welcher die beste Balance aus Geschwindigkeit und Qualität für deinen Anwendungsfall bietet. Dualplex ist derzeit als Beta gekennzeichnet.

<Tip>
**Pro-Tipp:** Nimm zwei Anrufe auf – einen in jedem Modus – und vergleiche die wahrgenommene Latenz und das Engagement-Level des Anrufers, um zu entscheiden, welcher zu deinem Arbeitsablauf passt.
</Tip>
...
Optimiere deine Assistenten-Einstellungen nach Modus
</Card>
<Card title="Stimmauswahl" icon="microphone" href="/de/ai-assistants/voice-selection">
Wähle die richtige Stimme für deinen Modus
</Card>
</CardGroup>

<CardGroup cols={2}>
<Card title="System-Prompt" icon="pen" href="/de/ai-assistants/system-prompt">
Schreibe modusoptimierte System-Prompts
</Card>
<Card title="Assistenten testen" icon="flask" href="/de/ai-assistants/testing">
Teste verschiedene Modi mit deinem Assistenten
</Card>
</CardGroup>

<Note>
Benötigst du Hilfe bei der Modusauswahl? Siehe [Best Practices](/de/ai-assistants/assistant-best-practices) für detaillierte Empfehlungen.
</Note>