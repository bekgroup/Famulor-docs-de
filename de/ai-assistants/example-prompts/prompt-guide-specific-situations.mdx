...
<Card
  ...
  color="purple">
    ...
    - Schauen Sie sich unseren <a href="/de/ai-assistants/example-prompts/general-prompt-engineering-guide">Allgemeinen Prompt Engineering Guide</a> an
    - Entdecken Sie unsere **Prompt-Vorlagen** im Dashboard
    - Lernen Sie mehr über <a href="/de/ai-assistants/example-prompts/pause-or-read-slowly">Sprachsteuerbarkeit</a>
