...
<CardGroup cols={2}>
  <Card title="Kostenlose Demo anfordern ⚡" href="https://app.famulor.de/demo" icon="play">
...
<Card>
  ...
  <CardGroup cols={2}>
    <Card title="Kostenlose Demo buchen" href="https://app.famulor.de/demo" icon="calendar">
