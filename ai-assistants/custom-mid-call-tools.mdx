...
Werkzeuge während des Anrufs ermöglichen es Ihrem KI-Assistenten, während Anrufen mit externen Systemen zu interagieren. Ob Lagerbestände prüfen, Kundendaten verifizieren oder Echtzeitinformationen abrufen – diese Tools machen Ihre KI leistungsfähiger und vernetzter.
...
1. **Tool-Erstellung aufrufen**
   ...
   Navigieren Sie zu "Werkzeuge während des Anrufs" und klicken Sie auf "Neues Mid-Call-Tool"
