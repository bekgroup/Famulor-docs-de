...
<CardGroup cols={3}>
  <Card title="Mid-Call-Tools verstehen" icon="lightbulb" href="/automation-platform/mid-call-tools/was-sind-mid-call-tools">
  ...
  <Card title="Anwendungsszenarien" icon="map" href="/automation-platform/mid-call-tools/wann-verwenden">
    Entdecken Sie, wann Mid-Call-Tools den größten Mehrwert bieten
  </Card>
