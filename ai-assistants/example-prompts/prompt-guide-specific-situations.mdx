...
<Card
  ...
  icon="volume-2"
  color="blue">
  Wir nutzen die "Langsam sprechen" Funktion, um Pausen zwischen Wörtern hinzuzufügen. Für weitere Informationen siehe die Dokumentation zur Sprachsteuerbarkeit.
...
<Card
  ...
  color="purple">
    ...
    - Entdecken Sie unsere **Prompt-Vorlagen**
